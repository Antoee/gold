...
| Runner scripts | All MT5 runner scripts use an approved launch guard | True | Runner scripts checked: 3; unguarded: 0 | Use the legacy hard-lock guard, or the workspace-isolated portable guard that requires focus-risk authorization, hidden launch, bounded cleanup, and frozen-artifact verification. |
...
| `run_mt5_portable_config_hidden.ps1` | True | PortableIsolation | False | False |
