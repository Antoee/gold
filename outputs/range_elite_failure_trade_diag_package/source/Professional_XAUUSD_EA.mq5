...
input datetime        InpBuyBlock2Start            = D'2025.07.01 00:00';
input datetime        InpBuyBlock2End              = D'2025.12.31 23:59';
...
input bool            InpUseMTFSlopeSellBlock      = false;
input int             InpSellBlockSlopeLookback    = 50;
input double          InpSellBlockMinUpSlopePts    = 500.0;
input bool            InpUseMTFSlopeDirectionFilter = false;
input int             InpDirectionSlopeLookback    = 50;
input double          InpBuyMinMTFSlopePts         = 0.0;
input double          InpSellMaxMTFSlopePts        = 0.0;
input bool            InpReverseSignals            = false;
bool                  InpUseAdaptiveReverse        = false;
input int             InpAdaptiveSlopeLookbackBars = 50;
...
input bool            InpAllowFlatMonthMomentumOutsideMonthFilter = false;
input bool            InpUseFlatMonthProbeMonthFilter = false;
input bool            InpFlatProbeTradeJanuary     = true;
input bool            InpFlatProbeTradeFebruary    = true;
input bool            InpFlatProbeTradeMarch       = true;
input bool            InpFlatProbeTradeApril       = true;
input bool            InpFlatProbeTradeMay         = true;
input bool            InpFlatProbeTradeJune        = true;
input bool            InpFlatProbeTradeJuly        = true;
input bool            InpFlatProbeTradeAugust      = true;
input bool            InpFlatProbeTradeSeptember   = true;
input bool            InpFlatProbeTradeOctober     = true;
input bool            InpFlatProbeTradeNovember    = true;
input bool            InpFlatProbeTradeDecember    = true;
...
input bool            InpAllowFlatMonthStructuralDisplacementOutsideMonthFilter = false;
input int             InpFlatMonthStructuralDisplacementBypassMinQualityScore = 8;
input int             InpFlatMonthStructuralDisplacementBypassMinPriceActionScore = 0;
input bool            InpFlatMonthStructuralDisplacementBypassRequireLiquidSession = true;
input bool            InpAllowFlatMonthLiquidityReclaimOutsideMonthFilter = false;
input int             InpFlatMonthLiquidityReclaimBypassMinQualityScore = 7;
input int             InpFlatMonthLiquidityReclaimBypassMinPriceActionScore = 0;
input bool            InpFlatMonthLiquidityReclaimBypassRequireLiquidSession = true;
input bool            InpAllowInSessionLiquidityPullbackOutsideMonthFilter = false;
...
input int             InpFlatMonthEntryScoreDiscount = 1;
input double          InpFlatMonthRRDiscount       = 0.10;
input double          InpFlatMonthRiskMultiplier   = 1.15;
input bool            InpFlatMonthRequireNoMonthlyLoss = true;
input bool            InpUseFlatMonthCatchUpRiskRamp = false;
input double          InpFlatMonthCatchUpStartGapPercent = 0.35;
input double          InpFlatMonthCatchUpFullGapPercent = 1.50;
input double          InpFlatMonthCatchUpMaxRiskMultiplier = 1.45;
input bool            InpFlatMonthCatchUpRequiresProtectedFloor = true;
input bool            InpFlatMonthCatchUpRiskRequiresLiquidSession = true;
input bool            InpUseFlatMonthCatchUpEntryRelaxation = false;
input int             InpFlatMonthCatchUpEntryScoreDiscount = 1;
input double          InpFlatMonthCatchUpRRDiscount = 0.05;
input bool            InpFlatMonthCatchUpRelaxBreakout = true;
input bool            InpFlatMonthCatchUpRelaxRangeReversion = true;
input bool            InpFlatMonthCatchUpRequireLiquidSession = true;
input bool            InpUseFlatMonthCatchUpStandaloneRelaxation = false;
input int             InpFlatMonthCatchUpStandaloneScoreDiscount = 1;
input double          InpFlatMonthCatchUpStandaloneMinProgress = 0.35;
input bool            InpFlatMonthCatchUpStandaloneRequireLiquidSession = true;
input bool            InpUseFlatMonthLateCatchUp = false;
input int             InpFlatMonthLateCatchUpMinDay = 18;
input int             InpFlatMonthLateCatchUpMaxMonthlyEntries = 12;
input double          InpFlatMonthLateCatchUpMinProgress = 0.35;
input int             InpFlatMonthLateCatchUpEntryScoreDiscount = 1;
input double          InpFlatMonthLateCatchUpRRDiscount = 0.05;
input double          InpFlatMonthLateCatchUpRiskMultiplier = 1.20;
input bool            InpFlatMonthLateCatchUpRequireLiquidSession = true;
input bool            InpUseFlatMonthProbeMode     = false;
input int             InpFlatMonthProbeMaxEntryCount = 4;
input int             InpFlatMonthProbeScoreDiscount = 1;
input double          InpFlatMonthProbeRRDiscount  = 0.05;
input double          InpFlatMonthProbeRiskMultiplier = 0.45;
input bool            InpFlatMonthProbeRangeOnly   = false;
input bool            InpFlatMonthProbeAllowBreakoutContinuation = false;
input double          InpFlatMonthProbeBreakoutRiskMultiplier = 0.35;
input int             InpFlatMonthProbeBreakoutMinQualityScore = 8;
input bool            InpUseFlatMonthProbeQualityRiskRamp = false;
input int             InpFlatMonthProbeQualityRiskFullScore = 13;
input double          InpFlatMonthProbeMaxRiskMultiplier = 0.85;
input bool            InpFlatMonthProbeQualityRampRequireProtectedFloor = true;
input bool            InpUseFlatMonthProbeQualityCapBypass = false;
input int             InpFlatMonthProbeCapBypassMinQualityScore = 12;
input int             InpFlatMonthProbeCapBypassMaxMonthlyEntries = 8;
input bool            InpFlatMonthProbeCapBypassRequireProtectedFloor = true;
input bool            InpFlatMonthProbeCapBypassRequireLiquidSession = true;
input bool            InpUseFlatMonthProbeLaneSpacing = true;
input int             InpFlatMonthProbeLaneSpacingMinutes = 45;
input bool            InpUseFlatMonthStaleEntryNudge = false;
input int             InpFlatMonthStaleEntryMinHours = 36;
input int             InpFlatMonthStaleEntryMaxMonthlyEntries = 6;
input int             InpFlatMonthStaleEntryConfirmationDiscount = 1;
input bool            InpFlatMonthStaleEntryRequireLiquidSession = true;
input bool            InpFlatMonthStaleAllowPowerTrend = true;
input bool            InpFlatMonthStaleAllowBreakout = true;
input bool            InpFlatMonthStaleAllowSessionImpulse = true;
input bool            InpFlatMonthStaleAllowRangeReversion = true;
input bool            InpUseFlatMonthMissedMoveWakeUp = false;
input int             InpFlatMonthMissedMoveMinHours = 24;
input int             InpFlatMonthMissedMoveMaxMonthlyEntries = 10;
input double          InpFlatMonthMissedMoveMinATR = 1.20;
input int             InpFlatMonthMissedMoveScoreDiscount = 1;
input double          InpFlatMonthMissedMoveRRDiscount = 0.05;
input bool            InpFlatMonthMissedMoveRequireLiquidSession = true;
input bool            InpFlatMonthMissedMoveAllowBreakout = true;
input bool            InpFlatMonthMissedMoveAllowSessionImpulse = true;
input bool            InpFlatMonthMissedMoveAllowPowerTrend = true;
input bool            InpUseFlatMonthMissedMoveTPExpansion = false;
input int             InpFlatMonthMissedMoveTPMinQualityScore = 11;
input int             InpFlatMonthMissedMoveTPMinPriceActionScore = 10;
input double          InpFlatMonthMissedMoveTPMultiplier = 1.25;
input bool            InpFlatMonthMissedMoveTPRequireTrailing = true;
input bool            InpUseFlatMonthEliteFallback = false;
input int             InpFlatMonthEliteFallbackMinHours = 48;
input int             InpFlatMonthEliteFallbackMaxMonthlyEntries = 6;
input int             InpFlatMonthEliteFallbackMaxConfirmationShortfall = 1;
input int             InpFlatMonthEliteFallbackMinQualityScore = 12;
input int             InpFlatMonthEliteFallbackMinPriceActionScore = 8;
input bool            InpFlatMonthEliteFallbackRequireLiquidSession = true;
input bool            InpUseFlatMonthBreakoutProbe = false;
input int             InpFlatMonthBreakoutProbeMinHours = 36;
input int             InpFlatMonthBreakoutProbeMaxMonthlyEntries = 8;
input int             InpFlatMonthBreakoutProbeMinScore = 7;
input double          InpFlatMonthBreakoutProbeRiskMultiplier = 0.45;
input bool            InpFlatMonthBreakoutProbeRequireLiquidSession = true;
input bool            InpFlatMonthBreakoutProbeRequireADX = true;
input double          InpFlatMonthBreakoutProbeMinADX = 20.0;
input double          InpFlatMonthBreakoutProbeMaxADX = 34.0;
input bool            InpFlatMonthBreakoutProbeRequireExecution = true;
input bool            InpFlatMonthBreakoutProbeRequireRangeExpansion = false;
input bool            InpFlatMonthBreakoutProbeAllowDonchian = true;
input bool            InpFlatMonthBreakoutProbeAllowDisplacementBOS = true;
input bool            InpFlatMonthBreakoutProbeAllowOpeningRange = true;
input double          InpFlatMonthBreakoutProbeMinRangeATR = 0.45;
input double          InpFlatMonthBreakoutProbeMaxOppositeWickPercent = 38.0;
input bool            InpFlatMonthBreakoutProbeUseStructuralStop = true;
input int             InpFlatMonthBreakoutProbeStopLookbackBars = 12;
input double          InpFlatMonthBreakoutProbeStopBufferATR = 0.12;
input double          InpFlatMonthBreakoutProbeStopBufferPoints = 25.0;
input double          InpFlatMonthBreakoutProbeMinStopATR = 0.35;
input double          InpFlatMonthBreakoutProbeMaxStopATR = 2.40;
input double          InpFlatMonthBreakoutProbeTakeProfitATR = 1.25;
input double          InpFlatMonthBreakoutProbeMinRR = 0.90;
...
input bool            InpUseFlatMonthStructuralDisplacementEfficiencyRelaxation = false;
input int             InpFlatMonthStructuralDisplacementRelaxAfterHours = 48;
input double          InpFlatMonthStructuralDisplacementRelaxMinCatchUpProgress = 0.20;
input double          InpFlatMonthStructuralDisplacementRelaxMinRangeATR = 0.55;
input double          InpFlatMonthStructuralDisplacementRelaxMinBodyPercent = 45.0;
input double          InpFlatMonthStructuralDisplacementRelaxMaxOppositeWickPercent = 38.0;
input int             InpFlatMonthStructuralDisplacementRelaxMinScore = 7;
input bool            InpFlatMonthStructuralDisplacementRelaxRequireSweepOrOrderFlow = true;
input bool            InpUseFlatMonthLiquidityReclaimLane = false;
input double          InpFlatMonthLiquidityReclaimRiskMultiplier = 0.20;
input int             InpFlatMonthLiquidityReclaimMaxMonthlyEntries = 4;
input int             InpFlatMonthLiquidityReclaimSpacingMinutes = 360;
input int             InpFlatMonthLiquidityReclaimMinScore = 6;
input bool            InpFlatMonthLiquidityReclaimRequireLiquidSession = true;
input bool            InpFlatMonthLiquidityReclaimRequireOrderFlow = true;
input bool            InpFlatMonthLiquidityReclaimUseImbalanceRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireImbalanceRetest = false;
input bool            InpFlatMonthLiquidityReclaimAllowImbalanceInsteadOfOrderFlow = false;
input bool            InpFlatMonthLiquidityReclaimUseImbalanceContinuation = false;
input bool            InpFlatMonthLiquidityReclaimRequireImbalanceContinuation = false;
input int             InpFlatMonthLiquidityReclaimImbalanceLookbackBars = 18;
input bool            InpFlatMonthLiquidityReclaimRequireVWAPReclaim = false;
input double          InpFlatMonthLiquidityReclaimMaxVWAPDistanceATR = 1.25;
input int             InpFlatMonthLiquidityReclaimLookbackBars = 18;
input double          InpFlatMonthLiquidityReclaimMinWickPercent = 32.0;
input double          InpFlatMonthLiquidityReclaimMinCloseLocation = 0.58;
input double          InpFlatMonthLiquidityReclaimStopBufferATR = 0.14;
input double          InpFlatMonthLiquidityReclaimStopBufferPoints = 30.0;
input double          InpFlatMonthLiquidityReclaimTakeProfitATR = 1.20;
input double          InpFlatMonthLiquidityReclaimMinRR = 0.90;
input bool            InpFlatMonthLiquidityReclaimUseEqualLevels = true;
input bool            InpFlatMonthLiquidityReclaimUsePreviousDay = true;
input bool            InpFlatMonthLiquidityReclaimUsePreviousWeek = false;
input bool            InpFlatMonthLiquidityReclaimUseLiquidityTarget = false;
input bool            InpFlatMonthLiquidityReclaimTargetUseEqualLevels = true;
input bool            InpFlatMonthLiquidityReclaimTargetUsePreviousDay = true;
input bool            InpFlatMonthLiquidityReclaimTargetUsePreviousWeek = false;
input bool            InpFlatMonthLiquidityReclaimTargetUseSessionRange = false;
input int             InpFlatMonthLiquidityReclaimTargetSessionLookbackHours = 8;
input bool            InpFlatMonthLiquidityReclaimTargetUseAsianRange = false;
input bool            InpFlatMonthLiquidityReclaimTargetUseSwingLevels = false;
input int             InpFlatMonthLiquidityReclaimSwingLookbackBars = 48;
input int             InpFlatMonthLiquidityReclaimSwingLeftBars = 2;
input int             InpFlatMonthLiquidityReclaimSwingRightBars = 2;
input bool            InpFlatMonthLiquidityReclaimRequireForwardClearance = false;
input double          InpFlatMonthLiquidityReclaimMinClearanceATR = 0.90;
input double          InpFlatMonthLiquidityReclaimMinTargetATR = 0.80;
input double          InpFlatMonthLiquidityReclaimMaxTargetATR = 2.40;
input bool            InpFlatMonthLiquidityReclaimUseRunnerTargetStretch = false;
input double          InpFlatMonthLiquidityReclaimRunnerTargetMultiplier = 1.25;
input bool            InpFlatMonthLiquidityReclaimAllowRecentRetest = false;
input int             InpFlatMonthLiquidityReclaimRetestLookbackBars = 5;
input double          InpFlatMonthLiquidityReclaimRetestToleranceATR = 0.18;
input double          InpFlatMonthLiquidityReclaimRetestTolerancePoints = 40.0;
input double          InpFlatMonthLiquidityReclaimRetestMinBodyPercent = 20.0;
input bool            InpFlatMonthLiquidityReclaimUseShelfRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireShelfRetest = false;
input int             InpFlatMonthLiquidityReclaimShelfRetestLookbackBars = 8;
input double          InpFlatMonthLiquidityReclaimShelfRetestToleranceATR = 0.14;
input double          InpFlatMonthLiquidityReclaimShelfRetestTolerancePoints = 35.0;
input double          InpFlatMonthLiquidityReclaimShelfRetestMinBodyPercent = 22.0;
input double          InpFlatMonthLiquidityReclaimShelfRetestMinCloseLocation = 0.56;
input bool            InpFlatMonthLiquidityReclaimUseContinuationRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireContinuationRetest = false;
input int             InpFlatMonthLiquidityReclaimContinuationLookbackBars = 8;
input double          InpFlatMonthLiquidityReclaimContinuationMaxPullbackATR = 0.65;
input double          InpFlatMonthLiquidityReclaimContinuationMinBodyPercent = 24.0;
input bool            InpFlatMonthLiquidityReclaimContinuationRequireEMAHold = false;
input bool            InpFlatMonthLiquidityReclaimContinuationRequireVWAPHold = false;
input bool            InpFlatMonthLiquidityReclaimUseCompressionBreakout = false;
input bool            InpFlatMonthLiquidityReclaimRequireCompressionBreakout = false;
input int             InpFlatMonthLiquidityReclaimCompressionLookbackBars = 14;
input double          InpFlatMonthLiquidityReclaimCompressionMaxRangeATR = 1.05;
input double          InpFlatMonthLiquidityReclaimCompressionBreakBufferPoints = 15.0;
input double          InpFlatMonthLiquidityReclaimCompressionMinBodyPercent = 40.0;
input double          InpFlatMonthLiquidityReclaimCompressionMinCloseLocation = 0.62;
input double          InpFlatMonthLiquidityReclaimCompressionMinBreakRangeATR = 0.45;
input bool            InpFlatMonthLiquidityReclaimUseBreakoutRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireBreakoutRetest = false;
input int             InpFlatMonthLiquidityReclaimBreakoutRetestLookbackBars = 6;
input double          InpFlatMonthLiquidityReclaimBreakoutRetestToleranceATR = 0.18;
input double          InpFlatMonthLiquidityReclaimBreakoutRetestTolerancePoints = 45.0;
input double          InpFlatMonthLiquidityReclaimBreakoutRetestMaxRetestATR = 0.75;
input double          InpFlatMonthLiquidityReclaimBreakoutRetestMinCloseLocation = 0.56;
input double          InpFlatMonthLiquidityReclaimBreakoutRetestMinVolumeRatio = 0.00;
input bool            InpFlatMonthLiquidityReclaimUseFailedBreakoutTrap = false;
input bool            InpFlatMonthLiquidityReclaimRequireFailedBreakoutTrap = false;
input int             InpFlatMonthLiquidityReclaimFailedBreakoutLookbackBars = 6;
input double          InpFlatMonthLiquidityReclaimFailedBreakoutMaxBoxRangeATR = 1.35;
input double          InpFlatMonthLiquidityReclaimFailedBreakoutMinReclaimRatio = 0.22;
input double          InpFlatMonthLiquidityReclaimFailedBreakoutMinVolumeRatio = 0.00;
input bool            InpFlatMonthLiquidityReclaimUseSessionRangeBreakout = false;
input bool            InpFlatMonthLiquidityReclaimRequireSessionRangeBreakout = false;
input bool            InpFlatMonthLiquidityReclaimSessionBreakoutUseAsianRange = true;
input bool            InpFlatMonthLiquidityReclaimSessionBreakoutUseRollingRange = true;
input int             InpFlatMonthLiquidityReclaimSessionBreakoutLookbackHours = 6;
input double          InpFlatMonthLiquidityReclaimSessionBreakoutMaxRangeATR = 1.25;
input double          InpFlatMonthLiquidityReclaimSessionBreakoutBufferPoints = 20.0;
input double          InpFlatMonthLiquidityReclaimSessionBreakoutMinBodyPercent = 38.0;
input double          InpFlatMonthLiquidityReclaimSessionBreakoutMinCloseLocation = 0.62;
input double          InpFlatMonthLiquidityReclaimSessionBreakoutMinBreakRangeATR = 0.45;
input bool            InpFlatMonthLiquidityReclaimUseOpeningRangeReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireOpeningRangeReclaim = false;
input int             InpFlatMonthLiquidityReclaimOpeningRangeStartHour = 7;
input int             InpFlatMonthLiquidityReclaimOpeningRangeStartMinute = 0;
input int             InpFlatMonthLiquidityReclaimOpeningRangeMinutes = 60;
input int             InpFlatMonthLiquidityReclaimOpeningRangeMaxBarsAfter = 20;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMaxRangeATR = 1.50;
input double          InpFlatMonthLiquidityReclaimOpeningRangeBreakBufferPoints = 18.0;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMinReclaimATR = 0.04;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMinBodyPercent = 24.0;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMinCloseLocation = 0.56;
input bool            InpFlatMonthLiquidityReclaimOpeningRangeUseRangeTarget = true;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMinTargetATR = 0.70;
input double          InpFlatMonthLiquidityReclaimOpeningRangeMaxTargetATR = 2.30;
input bool            InpFlatMonthLiquidityReclaimUseVWAPDeviationReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireVWAPDeviationReclaim = false;
input int             InpFlatMonthLiquidityReclaimVWAPDeviationLookbackBars = 36;
input int             InpFlatMonthLiquidityReclaimVWAPDeviationStopLookbackBars = 8;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMinATR = 0.65;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMaxATR = 2.20;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMinBodyPercent = 22.0;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMinCloseLocation = 0.55;
input bool            InpFlatMonthLiquidityReclaimVWAPDeviationUseVWAPTarget = true;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMinTargetATR = 0.45;
input double          InpFlatMonthLiquidityReclaimVWAPDeviationMaxTargetATR = 1.80;
input bool            InpFlatMonthLiquidityReclaimUseRangeFailureReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireRangeFailureReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRangeFailureUseAsianRange = true;
input bool            InpFlatMonthLiquidityReclaimRangeFailureUseRollingRange = true;
input int             InpFlatMonthLiquidityReclaimRangeFailureLookbackHours = 6;
input double          InpFlatMonthLiquidityReclaimRangeFailureMaxRangeATR = 1.60;
input double          InpFlatMonthLiquidityReclaimRangeFailureBreakBufferPoints = 18.0;
input double          InpFlatMonthLiquidityReclaimRangeFailureMinBodyPercent = 28.0;
input double          InpFlatMonthLiquidityReclaimRangeFailureMinCloseLocation = 0.58;
input double          InpFlatMonthLiquidityReclaimRangeFailureMinReclaimPercent = 0.18;
input bool            InpFlatMonthLiquidityReclaimRangeFailureUseRangeTarget = true;
input double          InpFlatMonthLiquidityReclaimRangeFailureMinTargetATR = 0.70;
input double          InpFlatMonthLiquidityReclaimRangeFailureMaxTargetATR = 2.20;
input bool            InpFlatMonthLiquidityReclaimUseHTFLiquidityReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireHTFLiquidityReclaim = false;
input bool            InpFlatMonthLiquidityReclaimHTFUsePreviousDay = true;
input bool            InpFlatMonthLiquidityReclaimHTFUsePreviousWeek = false;
input bool            InpFlatMonthLiquidityReclaimHTFUsePreviousMonth = false;
input double          InpFlatMonthLiquidityReclaimHTFBreakBufferPoints = 20.0;
input double          InpFlatMonthLiquidityReclaimHTFMinReclaimATR = 0.05;
input double          InpFlatMonthLiquidityReclaimHTFMinBodyPercent = 26.0;
input double          InpFlatMonthLiquidityReclaimHTFMinCloseLocation = 0.56;
input double          InpFlatMonthLiquidityReclaimHTFMaxLevelDistanceATR = 1.80;
input bool            InpFlatMonthLiquidityReclaimHTFUseOppositeTarget = true;
input double          InpFlatMonthLiquidityReclaimHTFMinTargetATR = 0.75;
input double          InpFlatMonthLiquidityReclaimHTFMaxTargetATR = 2.60;
input bool            InpFlatMonthLiquidityReclaimUseSweepDisplacementBOS = false;
input bool            InpFlatMonthLiquidityReclaimRequireSweepDisplacementBOS = false;
input int             InpFlatMonthLiquidityReclaimSweepBOSLookbackBars = 18;
input int             InpFlatMonthLiquidityReclaimSweepBOSMaxSweepAgeBars = 3;
input double          InpFlatMonthLiquidityReclaimSweepBOSBreakBufferPoints = 12.0;
input double          InpFlatMonthLiquidityReclaimSweepBOSMinRangeATR = 0.55;
input double          InpFlatMonthLiquidityReclaimSweepBOSMinBodyPercent = 42.0;
input double          InpFlatMonthLiquidityReclaimSweepBOSMinCloseLocation = 0.62;
input bool            InpFlatMonthLiquidityReclaimSweepBOSRequireVolumeExpansion = true;
input int             InpFlatMonthLiquidityReclaimSweepBOSVolumeLookbackBars = 18;
input double          InpFlatMonthLiquidityReclaimSweepBOSMinVolumeRatio = 1.15;
input bool            InpFlatMonthLiquidityReclaimUseDisplacementPullback = false;
input bool            InpFlatMonthLiquidityReclaimRequireDisplacementPullback = false;
input int             InpFlatMonthLiquidityReclaimDisplacementPullbackLookbackBars = 6;
input int             InpFMLRDispPBBreakLookbackBars = 18;
input double          InpFMLRDispPBBreakBufferPoints = 12.0;
input double          InpFlatMonthLiquidityReclaimDisplacementPullbackToleranceATR = 0.20;
input double          InpFlatMonthLiquidityReclaimDisplacementPullbackTolerancePoints = 45.0;
input double          InpFlatMonthLiquidityReclaimDisplacementPullbackMaxPullbackATR = 0.70;
input double          InpFlatMonthLiquidityReclaimDisplacementPullbackMinBodyPercent = 24.0;
input double          InpFMLRDispPBMinCloseLocation = 0.58;
input double          InpFMLRDispPBMinBreakRangeATR = 0.60;
input double          InpFMLRDispPBMinBreakBodyPercent = 44.0;
input bool            InpFlatMonthLiquidityReclaimUseEngulfingReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireEngulfingReclaim = false;
input int             InpFlatMonthLiquidityReclaimEngulfingLookbackBars = 16;
input double          InpFlatMonthLiquidityReclaimEngulfingBreakBufferPoints = 8.0;
input double          InpFlatMonthLiquidityReclaimEngulfingMaxSweepATR = 0.85;
input double          InpFlatMonthLiquidityReclaimEngulfingMinBodyPercent = 38.0;
input double          InpFlatMonthLiquidityReclaimEngulfingMinEngulfRatio = 0.90;
input double          InpFlatMonthLiquidityReclaimEngulfingMinCloseLocation = 0.58;
input bool            InpFlatMonthLiquidityReclaimUseTickPressureReclaim = false;
input bool            InpFlatMonthLiquidityReclaimRequireTickPressureReclaim = false;
input int             InpFlatMonthLiquidityReclaimTickPressureLookbackBars = 8;
input int             InpFlatMonthLiquidityReclaimTickPressureMinAlignedBars = 5;
input double          InpFlatMonthLiquidityReclaimTickPressureBreakBufferPoints = 8.0;
input double          InpFlatMonthLiquidityReclaimTickPressureMaxSweepATR = 0.90;
input double          InpFlatMonthLiquidityReclaimTickPressureMinBodyPercent = 24.0;
input double          InpFlatMonthLiquidityReclaimTickPressureMinCloseLocation = 0.56;
input double          InpFlatMonthLiquidityReclaimTickPressureMinDeltaRatio = 0.22;
input double          InpFlatMonthLiquidityReclaimTickPressureMinVolumeRatio = 1.10;
input bool            InpFlatMonthLiquidityReclaimUseFvgRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireFvgRetest = false;
input int             InpFlatMonthLiquidityReclaimFvgRetestLookbackBars = 10;
input int             InpFlatMonthLiquidityReclaimFvgRetestBreakLookbackBars = 16;
input double          InpFlatMonthLiquidityReclaimFvgRetestBreakBufferPoints = 12.0;
input double          InpFlatMonthLiquidityReclaimFvgRetestMinGapATR = 0.08;
input double          InpFlatMonthLiquidityReclaimFvgRetestToleranceATR = 0.16;
input double          InpFlatMonthLiquidityReclaimFvgRetestTolerancePoints = 40.0;
input double          InpFlatMonthLiquidityReclaimFvgRetestMaxRetestATR = 0.75;
input double          InpFlatMonthLiquidityReclaimFvgRetestMinImpulseRangeATR = 0.50;
input double          InpFlatMonthLiquidityReclaimFvgRetestMinImpulseBodyPercent = 38.0;
input double          InpFlatMonthLiquidityReclaimFvgRetestMinCloseLocation = 0.56;
input bool            InpFlatMonthLiquidityReclaimUseOrderBlockRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireOrderBlockRetest = false;
input int             InpFlatMonthLiquidityReclaimOrderBlockRetestLookbackBars = 10;
input int             InpFlatMonthLiquidityReclaimOrderBlockRetestBreakLookbackBars = 18;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestBreakBufferPoints = 12.0;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestToleranceATR = 0.18;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestTolerancePoints = 45.0;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestMaxBlockATR = 0.80;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestMaxRetestATR = 0.75;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestMinImpulseRangeATR = 0.55;
input double          InpFMLROBRetestMinImpulseBodyPercent = 42.0;
input double          InpFlatMonthLiquidityReclaimOrderBlockRetestMinCloseLocation = 0.58;
input bool            InpFlatMonthLiquidityReclaimUseChochRetest = false;
input bool            InpFlatMonthLiquidityReclaimRequireChochRetest = false;
input int             InpFlatMonthLiquidityReclaimChochRetestLookbackBars = 10;
input int             InpFlatMonthLiquidityReclaimChochRetestBreakLookbackBars = 14;
input double          InpFlatMonthLiquidityReclaimChochRetestBreakBufferPoints = 12.0;
input double          InpFlatMonthLiquidityReclaimChochRetestToleranceATR = 0.18;
input double          InpFlatMonthLiquidityReclaimChochRetestTolerancePoints = 45.0;
input double          InpFlatMonthLiquidityReclaimChochRetestMaxRetestATR = 0.70;
input double          InpFlatMonthLiquidityReclaimChochRetestMinBreakRangeATR = 0.45;
input double          InpFlatMonthLiquidityReclaimChochRetestMinBreakBodyPercent = 35.0;
input double          InpFlatMonthLiquidityReclaimChochRetestMinCloseLocation = 0.56;
input bool            InpFlatMonthLiquidityReclaimUsePhaseGate = false;
input bool            InpFlatMonthLiquidityReclaimAllowTrendPhase = true;
input bool            InpFlatMonthLiquidityReclaimAllowRangePhase = true;
input bool            InpFlatMonthLiquidityReclaimAllowTransitionPhase = true;
input bool            InpFlatMonthLiquidityReclaimTrendRequireEMASlope = true;
input int             InpFlatMonthLiquidityReclaimPhaseLookbackBars = 18;
input double          InpFlatMonthLiquidityReclaimTrendMinADX = 21.0;
input double          InpFlatMonthLiquidityReclaimRangeMaxADX = 18.0;
input double          InpFlatMonthLiquidityReclaimTrendMinSlopePoints = 25.0;
input double          InpFlatMonthLiquidityReclaimRangeMaxNetMoveATR = 1.15;
input double          InpFlatMonthLiquidityReclaimRangeMinAlternationPercent = 45.0;
input bool            InpFlatMonthLiquidityReclaimUseStopClusterBuffer = false;
input int             InpFlatMonthLiquidityReclaimStopClusterMinTouches = 3;
input double          InpFlatMonthLiquidityReclaimStopClusterProximityATR = 0.20;
input double          InpFlatMonthLiquidityReclaimStopClusterProximityPoints = 50.0;
input double          InpFlatMonthLiquidityReclaimStopClusterExtraBufferATR = 0.10;
input double          InpFlatMonthLiquidityReclaimStopClusterExtraBufferPoints = 30.0;
input bool            InpFlatMonthLiquidityReclaimUseStopPocketShift = false;
input int             InpFlatMonthLiquidityReclaimStopPocketLookbackBars = 24;
input double          InpFlatMonthLiquidityReclaimStopPocketProximityATR = 0.18;
input double          InpFlatMonthLiquidityReclaimStopPocketProximityPoints = 45.0;
input double          InpFlatMonthLiquidityReclaimStopPocketBufferATR = 0.22;
input double          InpFlatMonthLiquidityReclaimStopPocketBufferPoints = 55.0;
input bool            InpFlatMonthLiquidityReclaimUseStructureTrail = false;
input double          InpFlatMonthLiquidityReclaimStructureTrailStartR = 0.85;
input bool            InpCloseOnOppositeSignal     = false;
input bool            InpUseWinnerScaleIn          = false;
input double          InpWinnerScaleInMinProfitR   = 0.80;
input bool            InpWinnerScaleInRequireProtectedStop = true;
input double          InpWinnerScaleInMinLockedR   = 0.00;
input bool            InpWinnerScaleInRequireTrendRegime = false;
input bool            InpWinnerScaleInRequirePowerTrendContinuation = false;
input bool            InpWinnerScaleInAllowSessionImpulse = false;
input bool            InpWinnerScaleInAllowFlatMonthLiquidityReclaim = false;
input int             InpWinnerScaleInMinQualityScore = 8;
input int             InpWinnerScaleInMinPriceActionScore = 0;
input double          InpWinnerScaleInRiskMultiplier = 0.50;
input bool            InpUseHouseMoneyScaleInRiskRamp = false;
input double          InpHouseMoneyScaleInRiskStartCushionPercent = 6.0;
input double          InpHouseMoneyScaleInRiskFullCushionPercent = 18.0;
input double          InpMaxHouseMoneyScaleInRiskMultiplier = 0.85;
input int             InpWinnerScaleInMinMinutesSincePosition = 30;
input bool            InpWinnerScaleInRequireEquityAboveStarting = false;
input bool            InpWinnerScaleInBlockOnProfitGivebackQuality = false;
input bool            InpWinnerScaleInRequireOpenProfitRiskCover = false;
input double          InpWinnerScaleInOpenProfitRiskCoverage = 1.25;
...
input double          InpJanuaryRiskMultiplier     = 1.00;
input double          InpFebruaryRiskMultiplier    = 1.00;
input double          InpMarchRiskMultiplier       = 1.00;
input double          InpAprilRiskMultiplier       = 1.00;
input double          InpMayRiskMultiplier         = 1.00;
input double          InpJuneRiskMultiplier        = 1.00;
input double          InpJulyRiskMultiplier        = 1.00;
input double          InpAugustRiskMultiplier      = 1.00;
input double          InpSeptemberRiskMultiplier   = 1.00;
input double          InpOctoberRiskMultiplier     = 1.00;
input double          InpNovemberRiskMultiplier    = 1.00;
input double          InpDecemberRiskMultiplier    = 1.00;
input bool            InpUseStartingEquityProtection = false;
input double          InpStartingEquityBufferPercent = 0.00;
input bool            InpUseProfitOnlyRiskBoost    = false;
input double          InpProfitBoostStartPercent   = 1.00;
input double          InpProfitBoostFullPercent    = 10.00;
input double          InpMaxProfitBoostMultiplier  = 3.00;
input bool            InpGrowthBoostRequiresClosedProfit = false;
input bool            InpUseClosedProfitOpportunityRiskBoost = false;
input double          InpClosedProfitOpportunityStartPercent = 2.00;
input double          InpClosedProfitOpportunityFullPercent = 8.00;
input double          InpMaxClosedProfitOpportunityRiskMultiplier = 1.35;
input bool            InpClosedProfitOpportunityRequiresProtectedFloor = true;
input bool            InpUseHouseMoneyAccelerationGate = false;
input double          InpHouseMoneyMinClosedProfitPercent = 1.00;
input double          InpHouseMoneyMinProtectedCushionPercent = 3.00;
input double          InpHouseMoneyMaxRealizedGivebackPercent = 25.0;
input double          InpHouseMoneyMaxEquityPeakGivebackPercent = 25.0;
input bool            InpHouseMoneyRequireEquityAboveStarting = true;
input bool            InpUseEliteContinuationRiskAcceleration = false;
input int             InpEliteContinuationMinQualityScore = 14;
input int             InpEliteContinuationMinPriceActionScore = 16;
input double          InpEliteContinuationStartCushionPercent = 8.0;
input double          InpEliteContinuationFullCushionPercent = 20.0;
input double          InpEliteContinuationMaxRiskMultiplier = 1.60;
input bool            InpEliteContinuationRequireLiquidSession = true;
input bool            InpEliteContinuationRequireClosedProfit = true;
input bool            InpEliteContinuationAllowBreakout = true;
input bool            InpEliteContinuationAllowPowerTrend = true;
input bool            InpEliteContinuationAllowSessionImpulse = true;
input bool            InpUseEquityProfitLock       = false;
input double          InpEquityProfitLockStartPercent = 2.00;
input double          InpEquityProfitLockPercent   = 50.0;
...
input bool            InpUseBalanceProfitLock      = false;
input double          InpBalanceProfitLockStartPercent = 2.00;
input double          InpBalanceProfitLockPercent  = 50.0;
...
input bool            InpUseRecentPerformanceRiskThrottle = false;
input int             InpRecentPerformanceLookbackTrades = 5;
input double          InpRecentPerformanceMinNetPercent = 0.00;
input double          InpRecentPerformanceRiskFactor = 0.50;
input bool            InpUseRecentPerformanceTradePause = false;
input int             InpRecentPerformancePauseLookbackTrades = 5;
input double          InpRecentPerformancePauseMaxNetPercent = 0.00;
input int             InpRecentPerformancePauseMinutes = 180;
input bool            InpUseRecentPerformanceQualityGate = false;
input int             InpRecentPerformanceQualityLookbackTrades = 5;
input double          InpRecentPerformanceQualityMaxNetPercent = -0.20;
input int             InpRecentPerformanceMinQualityScore = 10;
input bool            InpUseRecentPerformanceRQualityGate = false;
input int             InpRecentPerformanceRLookbackTrades = 5;
input double          InpRecentPerformanceMaxAverageR = -0.15;
input int             InpRecentPerformanceRMinQualityScore = 11;
input bool            InpUseRecentPerformanceRTradePause = false;
input int             InpRecentPerformanceRPauseLookbackTrades = 5;
input double          InpRecentPerformancePauseMaxAverageR = -0.25;
input int             InpRecentPerformanceRPauseMinutes = 240;
input bool            InpUseRecentPerformanceRRiskScaling = false;
input int             InpRecentPerformanceRRiskLookbackTrades = 5;
input double          InpRecentPerformanceRRiskStartAverageR = 0.00;
input double          InpRecentPerformanceRRiskFullAverageR = -0.50;
input double          InpMinRecentPerformanceRRiskMultiplier = 0.50;
input bool            InpUseSetupLanePerformanceRiskScaling = false;
input int             InpSetupLanePerformanceLookbackTrades = 6;
input int             InpSetupLanePerformanceMinTrades = 3;
input double          InpSetupLaneWeakAverageR = -0.15;
input double          InpSetupLaneStrongAverageR = 0.45;
...
input double          InpHourPerformanceWeakNetPercent = -0.10;
input double          InpHourPerformanceStrongNetPercent = 0.25;
input double          InpMinHourPerformanceRiskMultiplier = 0.50;
input double          InpMaxHourPerformanceRiskMultiplier = 1.25;
input bool            InpHourPerformanceBoostRequiresClosedProfit = true;
input bool            InpUseHourPerformanceQualityGate = false;
input int             InpHourPerformanceMinQualityScore = 12;
input bool            InpUseDirectionalHourPerformanceRiskScaling = false;
input int             InpDirectionalHourPerformanceLookbackDays = 60;
input int             InpDirectionalHourPerformanceMinTrades = 3;
input double          InpDirectionalHourPerformanceWeakNetPercent = -0.10;
input double          InpDirectionalHourPerformanceStrongNetPercent = 0.25;
input double          InpMinDirectionalHourPerformanceRiskMultiplier = 0.50;
input double          InpMaxDirectionalHourPerformanceRiskMultiplier = 1.20;
input bool            InpDirectionalHourPerformanceBoostRequiresClosedProfit = true;
input bool            InpUseDirectionalHourPerformanceQualityGate = false;
input int             InpDirectionalHourPerformanceMinQualityScore = 13;
input bool            InpUseHotStreakRiskBoost    = false;
input int             InpHotStreakLookbackTrades  = 4;
input double          InpHotStreakStartAverageR   = 0.35;
input double          InpHotStreakFullAverageR    = 1.00;
input double          InpMaxHotStreakRiskMultiplier = 1.75;
input bool            InpHotStreakRequiresEquityProfit = true;
input bool            InpUseRecentProfitFactorRiskBoost = false;
input int             InpRecentProfitFactorLookbackTrades = 8;
input double          InpRecentProfitFactorStart = 1.25;
input double          InpRecentProfitFactorFull = 2.00;
input double          InpMaxRecentProfitFactorRiskMultiplier = 1.35;
input bool            InpRecentProfitFactorRequiresClosedProfit = true;
input bool            InpRecentProfitFactorRequiresEquityProfit = true;
input bool            InpUseDirectionalLossCooldown = false;
input int             InpDirectionalLossLookbackTrades = 4;
input int             InpDirectionalLossThreshold  = 2;
input int             InpDirectionalLossCooldownMinutes = 240;
input bool            InpUseDirectionalLossQualityGate = false;
input int             InpDirectionalLossQualityLookbackTrades = 4;
input int             InpDirectionalLossQualityThreshold = 2;
input int             InpDirectionalLossMinQualityScore = 9;
input bool            InpUseDirectionalLossRiskScaling = false;
input int             InpDirectionalLossRiskLookbackTrades = 4;
input int             InpDirectionalLossRiskThreshold = 2;
input double          InpDirectionalLossRiskMultiplier = 0.50;
input bool            InpUseQualityRiskScaling     = false;
input int             InpQualityRiskMinScore       = 5;
input int             InpQualityRiskFullScore      = 10;
input double          InpMinQualityRiskMultiplier  = 0.50;
input double          InpMaxQualityRiskMultiplier  = 1.00;
input bool            InpUsePriceActionRiskScaling = false;
input int             InpPriceActionRiskMinScore   = 9;
input int             InpPriceActionRiskFullScore  = 16;
input double          InpMinPriceActionRiskMultiplier = 0.50;
input double          InpMaxPriceActionRiskMultiplier = 1.00;
input bool            InpEliteSetupRiskRequiresEquityProfit = true;
input bool            InpUseMediocreSetupRiskThrottle = false;
input int             InpMediocreSetupMinQualityScore = 10;
input int             InpMediocreSetupMinPriceActionScore = 12;
input double          InpMediocreSetupRiskMultiplier = 0.50;
input bool            InpMediocreSetupBypassWithHouseMoney = true;
input bool            InpUseVolatilityRiskScaling  = false;
input int             InpVolatilityRiskLookbackBars = 24;
input double          InpVolatilityRiskStartRatio  = 1.25;
input double          InpVolatilityRiskFullRatio   = 1.80;
input double          InpMinVolatilityRiskMultiplier = 0.50;
...
input bool            InpUseStartingEquityRecoveryQualityGate = false;
input double          InpStartingEquityRecoveryStartDrawdownPercent = 0.25;
input double          InpStartingEquityRecoveryFullDrawdownPercent = 3.00;
input int             InpStartingEquityRecoveryMinQualityScore = 12;
input int             InpStartingEquityRecoveryMaxQualityScore = 18;
input bool            InpUseProtectedFloorRiskScaling = false;
input double          InpProtectedFloorRiskStartPercent = 4.0;
input double          InpMinProtectedFloorRiskMultiplier = 0.25;
input bool            InpUseProtectedFloorCushionRiskCap = false;
input double          InpMaxProtectedFloorCushionRiskPercent = 35.0;
input bool            InpUseProtectedFloorQualityGate = false;
input double          InpProtectedFloorQualityStartPercent = 2.0;
input int             InpProtectedFloorMinQualityScore = 12;
input bool            InpUseRealizedProfitGivebackQualityGate = false;
input double          InpRealizedProfitGivebackStartPercent = 25.0;
input double          InpRealizedProfitGivebackFullPercent = 60.0;
input int             InpRealizedProfitGivebackMinQualityScore = 12;
input int             InpRealizedProfitGivebackMaxQualityScore = 16;
input bool            InpUseEquityPeakGivebackQualityGate = false;
input double          InpEquityPeakGivebackMinPeakProfitPercent = 2.00;
input double          InpEquityPeakGivebackStartPercent = 25.0;
input double          InpEquityPeakGivebackFullPercent = 60.0;
input int             InpEquityPeakGivebackMinQualityScore = 12;
input int             InpEquityPeakGivebackMaxQualityScore = 16;
input bool            InpUseProtectedCushionRiskBoost = false;
input double          InpProtectedCushionBoostStartPercent = 6.0;
input double          InpProtectedCushionBoostFullPercent = 18.0;
input double          InpMaxProtectedCushionBoostMultiplier = 1.50;
...
input bool            InpUseDailyProfitRiskScaling = false;
input double          InpDailyProfitRiskStartFraction = 0.50;
input double          InpMinDailyProfitRiskMultiplier = 0.50;
input bool            InpUseDailyProfitOpportunityRiskBoost = false;
input double          InpDailyProfitOpportunityStartFraction = 0.25;
input double          InpDailyProfitOpportunityFullFraction = 0.75;
input double          InpMaxDailyProfitOpportunityRiskMultiplier = 1.50;
input bool            InpDailyProfitOpportunityRequiresProtection = true;
...
input bool            InpUseWeeklyProfitRiskScaling = false;
input double          InpWeeklyProfitRiskStartFraction = 0.50;
input double          InpMinWeeklyProfitRiskMultiplier = 0.50;
input bool            InpUseMonthlyProfitLock      = false;
input double          InpMonthlyProfitLockPercent  = 6.00;
input bool            InpUseMonthlyProfitRiskScaling = false;
input double          InpMonthlyProfitRiskStartFraction = 0.50;
input double          InpMinMonthlyProfitRiskMultiplier = 0.50;
...
input bool            InpUseOpenBasketProfitTrail  = false;
input double          InpOpenBasketTrailMinProfitPercent = 0.75;
input double          InpOpenBasketTrailGivebackPercent = 35.0;
input int             InpOpenBasketTrailMinPositions = 1;
input bool            InpUseOpenBasketPartialHarvest = false;
input double          InpOpenBasketHarvestMinProfitPercent = 0.75;
input double          InpOpenBasketHarvestClosePercent = 25.0;
input int             InpOpenBasketHarvestMinPositions = 1;
input bool            InpOpenBasketHarvestMoveStop = true;
input double          InpOpenBasketHarvestStopLockR = 0.10;
input bool            InpUseOpenProfitAddOnQualityGate = false;
input double          InpOpenProfitAddOnMinProfitPercent = 0.50;
input int             InpOpenProfitAddOnMinPositions = 1;
input int             InpOpenProfitAddOnMinQualityScore = 13;
input int             InpOpenProfitAddOnMinPriceActionScore = 15;
...
input double          InpJanuaryMaxSpreadPoints    = 0.0;
input double          InpFebruaryMaxSpreadPoints   = 0.0;
input double          InpMarchMaxSpreadPoints      = 0.0;
input double          InpAprilMaxSpreadPoints      = 0.0;
input double          InpMayMaxSpreadPoints        = 0.0;
input double          InpJuneMaxSpreadPoints       = 0.0;
input double          InpJulyMaxSpreadPoints       = 0.0;
input double          InpAugustMaxSpreadPoints     = 0.0;
input double          InpSeptemberMaxSpreadPoints  = 0.0;
input double          InpOctoberMaxSpreadPoints    = 0.0;
input double          InpNovemberMaxSpreadPoints   = 0.0;
input double          InpDecemberMaxSpreadPoints   = 0.0;
...
input double          InpEstimatedRoundTurnCommissionPerLot = 0.00;
...
input double          InpHouseMoneyOpenRiskStartCushionPercent = 6.0;
input double          InpHouseMoneyOpenRiskFullCushionPercent = 18.0;
input double          InpHouseMoneyMaxOpenRiskPercent = 12.00;
...
input int             InpQualityTPMinScore         = 7;
input int             InpQualityTPFullScore        = 12;
input double          InpMinQualityTPMultiplier    = 0.85;
input double          InpMaxQualityTPMultiplier    = 1.35;
input bool            InpUseQualityTPMonthFilter   = false;
input bool            InpQualityTPTradeJanuary     = true;
input bool            InpQualityTPTradeFebruary    = true;
input bool            InpQualityTPTradeMarch       = true;
input bool            InpQualityTPTradeApril       = true;
input bool            InpQualityTPTradeMay         = true;
input bool            InpQualityTPTradeJune        = true;
input bool            InpQualityTPTradeJuly        = true;
input bool            InpQualityTPTradeAugust      = true;
input bool            InpQualityTPTradeSeptember   = true;
input bool            InpQualityTPTradeOctober     = true;
input bool            InpQualityTPTradeNovember    = true;
input bool            InpQualityTPTradeDecember    = true;
input bool            InpUseRunnerTakeProfitExpansion = false;
input int             InpRunnerMinQualityScore     = 12;
input int             InpRunnerMinPriceActionScore = 14;
input double          InpRunnerTakeProfitMultiplier = 1.75;
input bool            InpRunnerRequireTrailing     = true;
input bool            InpUseTrendRegimeTakeProfitExpansion = false;
input int             InpTrendRegimeTPMinQualityScore = 12;
input int             InpTrendRegimeTPMinPriceActionScore = 14;
input double          InpTrendRegimeTPMultiplier   = 1.50;
input bool            InpTrendRegimeTPRequireTrailing = true;
input bool            InpTrendRegimeTPRequiresEquityProfit = true;
input bool            InpUseFlatMonthCatchUpTakeProfitExpansion = false;
input int             InpFlatMonthCatchUpTPMinQualityScore = 12;
input int             InpFlatMonthCatchUpTPMinPriceActionScore = 14;
input double          InpFlatMonthCatchUpTPMultiplier = 1.35;
input bool            InpFlatMonthCatchUpTPRequireLiquidSession = true;
input bool            InpFlatMonthCatchUpTPRequireTrailing = true;
input bool            InpUseProtectedCushionTakeProfitExpansion = false;
input int             InpProtectedCushionTPMinQualityScore = 12;
input int             InpProtectedCushionTPMinPriceActionScore = 14;
input double          InpProtectedCushionTPStartPercent = 6.0;
input double          InpProtectedCushionTPFullPercent = 18.0;
input double          InpProtectedCushionTPMultiplier = 1.50;
input bool            InpProtectedCushionTPRequireTrailing = true;
input bool            InpUseDirectionalHourTakeProfitExpansion = false;
input int             InpDirectionalHourTPMinQualityScore = 13;
input int             InpDirectionalHourTPMinPriceActionScore = 15;
input double          InpDirectionalHourTPMinNetPercent = 0.25;
input double          InpDirectionalHourTPMultiplier = 1.35;
input bool            InpDirectionalHourTPRequireTrailing = true;
input bool            InpDirectionalHourTPRequiresClosedProfit = true;
input bool            InpUseClosedProfitTakeProfitExpansion = false;
input int             InpClosedProfitTPMinQualityScore = 13;
input int             InpClosedProfitTPMinPriceActionScore = 15;
input double          InpClosedProfitTPStartPercent = 2.00;
input double          InpClosedProfitTPFullPercent = 8.00;
input double          InpClosedProfitTPMultiplier = 1.35;
input bool            InpClosedProfitTPRequireTrailing = true;
input bool            InpClosedProfitTPRequiresProtectedFloor = true;
input bool            InpUseEliteConfluenceTakeProfitExpansion = false;
input int             InpEliteConfluenceTPMinQualityScore = 15;
input int             InpEliteConfluenceTPMinPriceActionScore = 18;
input double          InpEliteConfluenceTPMultiplier = 1.40;
input bool            InpEliteConfluenceTPRequireTrailing = true;
input bool            InpEliteConfluenceTPRequiresHouseMoney = true;
input bool            InpUseProtectedCushionUnlimitedRunner = false;
input int             InpProtectedRunnerMinQualityScore = 14;
input int             InpProtectedRunnerMinPriceActionScore = 16;
input double          InpProtectedRunnerMinCushionPercent = 12.0;
input bool            InpProtectedRunnerRequireTrendRegime = true;
input bool            InpProtectedRunnerRequireTrailing = true;
input bool            InpProtectedRunnerRequireProfitLock = true;
input bool            InpUseEliteContinuationUnlimitedRunner = false;
input int             InpEliteContinuationRunnerMinQualityScore = 15;
input int             InpEliteContinuationRunnerMinPriceActionScore = 18;
input double          InpEliteContinuationRunnerMinCushionPercent = 10.0;
input bool            InpEliteContinuationRunnerRequireRiskAcceleration = true;
input bool            InpEliteContinuationRunnerRequireTrailing = true;
input bool            InpEliteContinuationRunnerRequireProfitLock = true;
...
input int             InpSwingPivotStopLookbackBars = 24;
input int             InpSwingPivotStopLeftBars    = 2;
input int             InpSwingPivotStopRightBars   = 2;
input double          InpSwingPivotStopBufferATR   = 0.10;
input double          InpSwingPivotStopBufferPoints = 25.0;
input double          InpSwingPivotStopMinATR      = 0.65;
input double          InpSwingPivotStopMaxATR      = 2.40;
input bool            InpSwingPivotStopTightenOnly = true;
...
input int             InpLiquidityClusterMinTouches = 3;
input double          InpLiquidityClusterProximityATR = 0.22;
input double          InpLiquidityClusterProximityPoints = 60.0;
input double          InpLiquidityClusterExtraBufferATR = 0.12;
input double          InpLiquidityClusterExtraBufferPoints = 35.0;
input bool            InpUseLiquidityPocketStopShift = false;
input int             InpLiquidityPocketLookbackBars = 24;
input double          InpLiquidityPocketProximityATR = 0.18;
input double          InpLiquidityPocketProximityPoints = 45.0;
input double          InpLiquidityPocketBufferATR = 0.22;
input double          InpLiquidityPocketBufferPoints = 55.0;
...
input double          InpMaxStopATRMultiplier      = 3.00;
...
input int             InpFastTrendEMAPeriod        = 100;
input bool            InpUseEMASlope               = true;
input int             InpSlopeLookbackBars         = 5;
input double          InpMinSlopePoints            = 25;
input bool            InpUseMTFTrend               = true;
input ENUM_TIMEFRAMES InpMTFTrendTimeframe         = PERIOD_H1;
input int             InpMTFEMAPeriod              = 200;
input bool            InpUseMTFTrendQualityGuard   = false;
input int             InpMTFQualitySlopeLookback   = 20;
input double          InpMTFQualityMinSlopePoints  = 50.0;
input double          InpMTFQualityMaxDistanceATR  = 3.00;
input bool            InpUseADXFilter              = true;
input int             InpADXPeriod                 = 14;
input double          InpMinADX                    = 18.0;
input bool            InpUseATRVolatilityFilter    = true;
input double          InpMinATRPoints              = 80;
input double          InpMaxATRPoints              = 900;

//--- Entry engine
input group "Entry Engine"
input int             InpMinimumConfirmations      = 2;
input bool            InpUseDirectionalConfirmations = false;
input int             InpBuyMinimumConfirmations   = 2;
input int             InpSellMinimumConfirmations  = 2;
input bool            InpUseWeightedEntryScore     = false;
input int             InpMinimumEntryScore         = 5;
...
input bool            InpDiagnosticFallbackDebug = false;
...
input double          InpM5TightLiquidityRiskMultiplier = 1.50;
input int             InpM5TightLiquidityMaxMonthlyEntries = 8;
input double          InpM5TightLiquidityMinADX = 22.0;
input int             InpM5TightLiquidityADXStrengthLookback = 4;
input double          InpM5TightLiquidityADXMinIncrease = 1.0;
input int             InpM5TightLiquidityTrendEMAPeriod = 200;
input int             InpM5TightLiquidityTrendSlopeLookback = 8;
input double          InpM5TightLiquidityMinSlopePoints = 20.0;
input int             InpM5TightLiquidityBOSLookbackBars = 20;
input int             InpM5TightLiquiditySweepLookbackBars = 10;
input int             InpM5TightLiquidityStopLookbackBars = 10;
input double          InpM5TightLiquidityStopBufferATR = 0.08;
input double          InpM5TightLiquidityStopBufferPoints = 15.0;
input double          InpM5TightLiquidityStopATRMultiplier = 1.10;
input double          InpM5TightLiquidityTakeProfitATRMultiplier = 2.40;
input double          InpM5TightLiquidityMinRR = 1.25;
input bool            InpM5TightLiquidityRequireM15Alignment = true;
input bool            InpM5TightLiquidityAllowPrimaryOverride = false;
input int             InpM5TightLiquidityOverrideMaxPrimaryQuality = 6;
input bool            InpM5TightLiquidityOverrideRequireSameBias = true;
...
input bool            InpUseEliteEntryQualityGate  = false;
input int             InpEliteEntryMinQualityScore = 12;
input int             InpEliteEntryMinPriceActionScore = 14;
input int             InpEliteEntryMinConfirmations = 3;
input int             InpWeightEMACross            = 1;
input int             InpWeightEMAPullback         = 2;
input int             InpWeightBOS                 = 2;
input int             InpWeightDisplacementBOS     = 2;
input int             InpWeightBreakoutRetest      = 2;
input int             InpWeightLiquiditySweep      = 2;
input int             InpWeightSweepRejection      = 2;
input int             InpWeightCHoCH               = 2;
input int             InpWeightFairValueGap        = 2;
input int             InpWeightFVGRetest           = 2;
input int             InpWeightOrderBlock          = 2;
input int             InpWeightEqualLevelSweep     = 2;
input int             InpWeightPreviousLevels      = 1;
input int             InpWeightSessionLevelSweep   = 1;
input int             InpWeightRoundNumberRejection = 1;
input int             InpWeightOpeningRangeBreakout = 2;
input int             InpWeightAsianRangeSweep     = 2;
input int             InpWeightCompressionBreakout = 2;
input int             InpWeightRangeExpansionBreakout = 2;
input int             InpWeightNarrowRangeBreakout = 2;
input int             InpWeightDonchianBreakout    = 2;
input int             InpWeightFailedBreakoutReversal = 2;
input int             InpWeightDailyOpenBias       = 1;
input int             InpWeightPreviousDayRangeBias = 1;
input int             InpWeightRangeLocationBias   = 1;
input int             InpWeightVWAP                = 1;
input int             InpWeightVWAPPullback        = 2;
input int             InpWeightMomentum            = 1;
input int             InpWeightEngulfing           = 1;
input int             InpWeightPinBar              = 1;
input int             InpWeightATRExpansion        = 1;
input int             InpWeightVolume              = 1;
input int             InpWeightCandleAnatomy       = 1;
input int             InpWeightRSI                 = 1;
input int             InpWeightMACD                = 1;
input int             InpWeightBollinger           = 1;
input int             InpWeightStochastic          = 1;
input int             InpWeightCCI                 = 1;
input int             InpWeightMFI                 = 1;
input int             InpWeightOBV                 = 1;
input int             InpWeightDIDirection         = 1;
input int             InpWeightADXStrengthening    = 1;
input int             InpWeightTickMicrostructure  = 2;
input int             InpWeightCumulativeDelta     = 2;
input int             InpWeightDisplacementCandle  = 2;
input int             InpWeightTickPressureCandle  = 2;
input int             InpWeightTickSpeedImpulse    = 2;
input int             InpWeightRegimeQuality       = 2;
input int             InpWeightCorrelation         = 1;
input int             InpWeightSmartMoneyQuality   = 3;
input int             InpWeightPriceActionComposite = 3;
input int             InpWeightBreakoutContinuationQuality = 3;
input int             InpWeightSessionImpulseLane  = 3;
input bool            InpUseEMACrossEntry          = false;
input int             InpEntryFastEMAPeriod        = 20;
input int             InpEntrySlowEMAPeriod        = 50;
input bool            InpUseEMAPullbackContinuation = false;
input double          InpEMAPullbackMaxDistanceATR = 0.35;
input double          InpEMAPullbackMinBodyPercent = 35.0;
input bool            InpUseBOS                    = true;
input int             InpBOSLookbackBars           = 20;
input bool            InpUseDisplacementBOS        = false;
input int             InpDisplacementBOSLookbackBars = 20;
input double          InpDisplacementBOSBufferPoints = 10.0;
input double          InpDisplacementBOSMinRangeATR = 0.70;
input double          InpDisplacementBOSMinBodyPercent = 50.0;
input bool            InpUseBreakoutRetest         = false;
input int             InpBreakoutRetestLookbackBars = 20;
input double          InpBreakoutRetestATR         = 0.25;
input double          InpBreakoutRetestCloseBufferPoints = 10.0;
input bool            InpUseLiquiditySweep         = true;
input int             InpSweepLookbackBars         = 10;
input bool            InpUseSweepRejection         = false;
input double          InpSweepRejectionMinWickPercent = 35.0;
input double          InpSweepRejectionMinCloseLocation = 0.60;
input bool            InpUseSwingRecencyFilter     = false;
input int             InpSwingLeftBars             = 2;
input int             InpSwingRightBars            = 2;
input int             InpMaxBarsSinceSwing         = 24;
input bool            InpUseMomentumCandle         = false;
input double          InpMomentumBodyATR           = 0.50;
input bool            InpUseEngulfing              = false;
input bool            InpUsePinBar                 = false;
input double          InpPinWickToBodyRatio        = 2.0;
input bool            InpUseATRExpansion           = false;
input double          InpATRExpansionMultiplier    = 1.20;
input bool            InpUseVolumeConfirmation     = false;
input int             InpVolumeLookbackBars        = 20;
input bool            InpUseTickVolumeRegimeGuard  = false;
input int             InpTickVolumeRegimeLookbackBars = 20;
input double          InpMinTickVolumeRatio        = 0.60;
input double          InpMaxTickVolumeRatio        = 2.80;
input bool            InpUseVolumeDryUpGuard       = false;
input int             InpVolumeDryUpLookbackBars   = 24;
input int             InpVolumeDryUpConsecutiveBars = 3;
input double          InpVolumeDryUpMaxRatio       = 0.55;
...
input bool            InpUseGapRiskGuard           = false;
input double          InpMaxGapATR                 = 0.60;
input double          InpMaxGapPoints              = 250.0;
...
input bool            InpUseFailedBreakoutReversal = false;
input int             InpFailedBreakoutReversalLookbackBars = 12;
input double          InpFailedBreakoutReversalBufferPoints = 10.0;
input double          InpFailedBreakoutReversalMinCloseLocation = 0.60;
input bool            InpUseEntryShockGuard        = false;
input double          InpMaxEntryCandleATR         = 2.20;
input double          InpMinEntryBodyPercent       = 30.0;
input bool            InpUseCHoCH                  = false;
input int             InpCHoCHLookbackBars         = 16;
input bool            InpUseFairValueGap           = false;
input int             InpFVGLookbackBars           = 8;
input double          InpFVGMinATR                  = 0.10;
input bool            InpUseFVGRetest              = false;
input double          InpFVGRetestBufferATR        = 0.20;
input bool            InpUseOrderBlock             = false;
input int             InpOrderBlockLookbackBars    = 20;
input double          InpOrderBlockRetestATR       = 0.25;
input bool            InpUseEqualHighLowSweep      = false;
input int             InpEqualLevelLookbackBars    = 16;
input double          InpEqualLevelTolerancePoints = 80;
input bool            InpUsePreviousLevels         = false;
input bool            InpUsePreviousDayLevels      = true;
input bool            InpUsePreviousWeekLevels     = true;
input bool            InpUsePreviousMonthLevels    = false;
input double          InpLevelRejectionBufferPoints = 40;
input bool            InpUseLevelProximityGuard    = false;
input bool            InpLevelGuardUsePreviousDay  = true;
input bool            InpLevelGuardUsePreviousWeek = true;
input bool            InpLevelGuardUsePreviousMonth = false;
input bool            InpLevelGuardUseRecentSwings = false;
input int             InpLevelGuardSwingLookbackBars = 30;
input double          InpMinDistanceFromLevelATR   = 0.35;
input double          InpMinDistanceFromLevelPoints = 80.0;
input bool            InpUseSessionLevelSweep      = false;
input int             InpSessionLevelLookbackHours = 8;
input bool            InpUseRoundNumberRejection   = false;
input double          InpRoundNumberStepPoints     = 1000.0;
input double          InpRoundNumberBufferPoints   = 80.0;
input bool            InpUseOpeningRangeBreakout   = false;
input int             InpOpeningRangeStartHour     = 7;
input int             InpOpeningRangeStartMinute   = 0;
input int             InpOpeningRangeMinutes       = 60;
input int             InpOpeningRangeMaxBarsAfter  = 16;
input double          InpOpeningRangeBufferPoints  = 20.0;
input bool            InpUseAsianRangeSweep        = false;
input int             InpAsianRangeStartHour       = 0;
input int             InpAsianRangeStartMinute     = 0;
input int             InpAsianRangeEndHour         = 6;
input int             InpAsianRangeEndMinute       = 0;
input int             InpAsianRangeMaxBarsAfter    = 32;
input double          InpAsianSweepBufferPoints    = 20.0;
input bool            InpUseCompressionBreakout    = false;
input int             InpCompressionLookbackBars   = 12;
input double          InpCompressionMaxRangeATR    = 1.10;
input double          InpCompressionBreakBufferPoints = 15.0;
input double          InpCompressionMinBodyPercent = 45.0;
input bool            InpUseRangeExpansionBreakout = false;
input int             InpRangeExpansionLookbackBars = 12;
input double          InpRangeExpansionMinRangeRatio = 1.35;
input double          InpRangeExpansionMinATR      = 0.55;
input double          InpRangeExpansionMinBodyPercent = 45.0;
input double          InpRangeExpansionCloseLocation = 0.65;
input double          InpRangeExpansionBufferPoints = 15.0;
input bool            InpUseNarrowRangeBreakout    = false;
input int             InpNarrowRangeLookbackBars   = 12;
input double          InpNarrowRangeMaxAverageRatio = 0.70;
input double          InpNarrowRangeMaxATR         = 0.45;
input double          InpNarrowBreakMinRangeATR    = 0.50;
input double          InpNarrowBreakMinBodyPercent = 45.0;
input double          InpNarrowBreakCloseLocation  = 0.65;
input double          InpNarrowBreakBufferPoints   = 10.0;
input bool            InpUseDonchianBreakout       = false;
input int             InpDonchianLookbackBars      = 24;
input double          InpDonchianBreakBufferPoints = 20.0;
input double          InpDonchianMinBodyPercent    = 35.0;
input bool            InpUseDailyOpenBias          = false;
input double          InpDailyOpenBiasBufferPoints = 30.0;
input bool            InpUsePreviousDayRangeBias   = false;
input ENUM_PREVIOUS_DAY_RANGE_MODE InpPreviousDayRangeMode = PREV_DAY_RANGE_HALF_BIAS;
input double          InpPreviousDayRangeBufferPoints = 30.0;
input bool            InpUseRangeLocationBias      = false;
input int             InpRangeLocationLookbackBars = 24;
input double          InpRangeLocationBuyMinPercent = 55.0;
input double          InpRangeLocationSellMaxPercent = 45.0;
input bool            InpUseVWAPConfirmation       = false;
input int             InpVWAPLookbackBars          = 96;
input double          InpVWAPMaxDistanceATR        = 1.20;
input bool            InpUseVWAPPullbackContinuation = false;
input double          InpVWAPPullbackMaxDistanceATR = 0.35;
input double          InpVWAPPullbackMinBodyPercent = 35.0;
input bool            InpUseVWAPDistanceGuard      = false;
input double          InpVWAPGuardMaxDistanceATR   = 1.60;
input bool            InpUseSmartMoneyQualityGate  = false;
input int             InpSmartMoneyMinScore        = 6;
input bool            InpSmartMoneyRequireStructure = true;
input bool            InpSmartMoneyRequireLiquidityOrImbalance = true;
input bool            InpSmartMoneyRequireExecution = true;
input bool            InpSmartMoneyRequireOrderFlow = false;
input bool            InpUsePriceActionCompositeGate = false;
input int             InpPriceActionCompositeMinScore = 9;
input bool            InpPriceActionRequireStructure = true;
input bool            InpPriceActionRequireLiquidity = true;
input bool            InpPriceActionRequireExecution = true;
input bool            InpPriceActionRequireOrderFlow = false;
input bool            InpUseBreakoutContinuationQuality = false;
input int             InpBreakoutContinuationMinScore = 7;
input bool            InpBreakoutContinuationRequireExecution = true;
input bool            InpBreakoutContinuationRequireOrderFlow = true;
input bool            InpBreakoutContinuationRequireRegime = true;
input bool            InpBreakoutContinuationStandaloneEntry = false;
input int             InpBreakoutContinuationStandaloneMinScore = 8;
input bool            InpBreakoutContinuationRequireFollowThroughClose = false;
input int             InpBreakoutContinuationFollowThroughLookback = 12;
input double          InpBreakoutContinuationFollowThroughBufferPoints = 20.0;
input bool            InpUsePowerTrendContinuation = false;
input int             InpPowerTrendContinuationMinScore = 10;
input double          InpPowerTrendContinuationMinADX = 28.0;
input bool            InpPowerTrendContinuationRequireLiquidSession = true;
input bool            InpPowerTrendContinuationRequireHouseMoney = true;
input bool            InpPowerTrendContinuationStandaloneEntry = true;
input int             InpPowerTrendContinuationStandaloneMinScore = 12;
input int             InpPowerTrendContinuationEntryScoreDiscount = 1;
input double          InpPowerTrendContinuationRiskMultiplier = 1.35;
input double          InpPowerTrendContinuationTPMultiplier = 1.35;
input bool            InpUsePowerTrendQualityRiskRamp = false;
input int             InpPowerTrendQualityRiskFullScore = 16;
input double          InpPowerTrendQualityMaxRiskMultiplier = 1.75;
input bool            InpUsePowerTrendContinuationMonthFilter = false;
input bool            InpPowerTrendTradeJanuary = true;
input bool            InpPowerTrendTradeFebruary = true;
input bool            InpPowerTrendTradeMarch = true;
input bool            InpPowerTrendTradeApril = true;
input bool            InpPowerTrendTradeMay = true;
input bool            InpPowerTrendTradeJune = true;
input bool            InpPowerTrendTradeJuly = true;
input bool            InpPowerTrendTradeAugust = true;
input bool            InpPowerTrendTradeSeptember = true;
input bool            InpPowerTrendTradeOctober = true;
input bool            InpPowerTrendTradeNovember = true;
input bool            InpPowerTrendTradeDecember = true;
input bool            InpUseSessionImpulseLane = false;
input int             InpSessionImpulseMinScore = 8;
input double          InpSessionImpulseMinADX = 20.0;
input bool            InpSessionImpulseRequireLiquidSession = true;
input bool            InpSessionImpulseRequireSessionBreak = true;
input bool            InpSessionImpulseRequireExecution = true;
input bool            InpSessionImpulseRequireOrderFlow = false;
input bool            InpSessionImpulseStandaloneEntry = true;
input int             InpSessionImpulseStandaloneMinScore = 9;
input int             InpSessionImpulseEntryScoreDiscount = 1;
input double          InpSessionImpulseRiskMultiplier = 1.20;
input double          InpSessionImpulseTPMultiplier = 1.20;
input bool            InpUseSessionImpulseQualityRiskRamp = false;
input int             InpSessionImpulseQualityRiskFullScore = 14;
input double          InpSessionImpulseQualityMaxRiskMultiplier = 1.45;
input double          InpSessionImpulseMinBodyPercent = 38.0;
input double          InpSessionImpulseMinRangeATR = 0.40;
input double          InpSessionImpulseMinCloseLocation = 0.64;
...
input bool            InpRangeReversionUseLiquidityStopExtension = false;
...
input int             InpRangeReversionEliteMinPriceActionScore = 0;
...
input double          InpFlatMonthMicroReversionMinCloseLocation = 0.56;
input double          InpFlatMonthMicroReversionMinRangeATR = 0.28;
input bool            InpFlatMonthMicroReversionRequireLiquidity = true;
input bool            InpFlatMonthMicroReversionRequireVWAP = false;
input double          InpFlatMonthMicroReversionMaxVWAPDistanceATR = 1.40;
input double          InpFlatMonthMicroReversionStopBufferATR = 0.10;
input double          InpFlatMonthMicroReversionStopBufferPoints = 22.0;
input double          InpFlatMonthMicroReversionFallbackTPATR = 0.95;
input double          InpFlatMonthMicroReversionMinRR = 0.75;
input bool            InpUseInSessionLiquidityPullbackLane = false;
input int             InpInSessionLiquidityPullbackMinScore = 7;
input double          InpInSessionLiquidityPullbackRiskMultiplier = 0.45;
input int             InpInSessionLiquidityPullbackMaxMonthlyEntries = 8;
input int             InpInSessionLiquidityPullbackSpacingMinutes = 120;
input bool            InpInSessionLiquidityPullbackRequireLiquidSession = true;
input bool            InpInSessionLiquidityPullbackRequireMTFAlignment = false;
input bool            InpInSessionLiquidityPullbackRequireLiquidity = true;
input bool            InpInSessionLiquidityPullbackRequireOrderFlow = false;
input int             InpInSessionLiquidityPullbackLookbackBars = 10;
input double          InpInSessionLiquidityPullbackMinATR = 0.0;
input bool            InpInSessionLiquidityPullbackLowATRRequireOrderFlow = false;
input double          InpInSessionLiquidityPullbackLowATRThreshold = 0.0;
input double          InpInSessionLiquidityPullbackMaxPullbackATR = 0.55;
input double          InpInSessionLiquidityPullbackMinBodyPercent = 28.0;
input double          InpInSessionLiquidityPullbackStopBufferATR = 0.12;
input double          InpInSessionLiquidityPullbackStopBufferPoints = 25.0;
input double          InpInSessionLiquidityPullbackTakeProfitATR = 1.40;
input double          InpInSessionLiquidityPullbackMinRR = 0.90;
input bool            InpUseInSessionLiquidityPullbackMonthFilter = false;
input bool            InpISLPTradeJanuary = true;
input bool            InpISLPTradeFebruary = true;
input bool            InpISLPTradeMarch = true;
input bool            InpISLPTradeApril = true;
input bool            InpISLPTradeMay = true;
input bool            InpISLPTradeJune = true;
input bool            InpISLPTradeJuly = true;
input bool            InpISLPTradeAugust = true;
input bool            InpISLPTradeSeptember = true;
input bool            InpISLPTradeOctober = true;
input bool            InpISLPTradeNovember = true;
input bool            InpISLPTradeDecember = true;
...
input bool            InpUseCandleAnatomy          = false;
input double          InpMinBodyPercent            = 45.0;
input double          InpMinDirectionalWickPercent = 30.0;
...
input bool            InpUseMarketPhaseRiskScaling = false;
input double          InpTrendPhaseRiskMultiplier  = 1.00;
input double          InpTransitionPhaseRiskMultiplier = 0.75;
input double          InpRangePhaseRiskMultiplier  = 0.50;
input bool            InpUseTrendRegimeRiskBoost  = false;
input double          InpTrendRegimeBoostADX      = 28.0;
input int             InpTrendRegimeBoostATRLookbackBars = 20;
input double          InpTrendRegimeBoostMinATRRatio = 1.05;
input double          InpTrendRegimeBoostFullATRRatio = 1.50;
input double          InpMaxTrendRegimeRiskMultiplier = 1.50;
input bool            InpTrendRegimeBoostRequiresEquityProfit = true;
...
input bool            InpUseRegimeQualityScore     = false;
input int             InpRegimeSlopeLookbackBars   = 8;
input double          InpRegimeMinSlopePoints      = 35.0;
input double          InpRegimeMinATRPercentile    = 0.85;
input double          InpRegimeMaxATRPercentile    = 1.75;
...
input bool            InpUseRSIConfirmation        = false;
input int             InpRSIPeriod                 = 14;
input double          InpRSIBuyMin                 = 52.0;
input double          InpRSISellMax                = 48.0;
input bool            InpUseRSIExhaustionGuard     = false;
input double          InpRSIBuyMax                 = 72.0;
input double          InpRSISellMin                = 28.0;
input bool            InpUseMACDConfirmation       = false;
input int             InpMACDFastEMA               = 12;
input int             InpMACDSlowEMA               = 26;
input int             InpMACDSignalSMA             = 9;
input bool            InpUseBollingerConfirmation  = false;
input int             InpBollingerPeriod           = 20;
input double          InpBollingerDeviation        = 2.0;
input bool            InpUseBollingerExtensionGuard = false;
input double          InpBollingerExtensionBuffer  = 0.10;
input bool            InpUseStochasticConfirmation = false;
input int             InpStochasticKPeriod         = 14;
input int             InpStochasticDPeriod         = 3;
input int             InpStochasticSlowing         = 3;
input double          InpStochasticBuyMin          = 55.0;
input double          InpStochasticSellMax         = 45.0;
input bool            InpUseStochasticExhaustionGuard = false;
input double          InpStochasticBuyMax          = 85.0;
input double          InpStochasticSellMin         = 15.0;
input bool            InpUseCCIConfirmation        = false;
input int             InpCCIPeriod                 = 20;
input double          InpCCIBuyMin                 = 50.0;
input double          InpCCISellMax                = -50.0;
input bool            InpUseCCIExhaustionGuard     = false;
input double          InpCCIBuyMax                 = 200.0;
input double          InpCCISellMin                = -200.0;
input bool            InpUseMFIConfirmation        = false;
input int             InpMFIPeriod                 = 14;
input double          InpMFIBuyMin                 = 55.0;
input double          InpMFISellMax                = 45.0;
input bool            InpUseMFIExhaustionGuard     = false;
input double          InpMFIBuyMax                 = 82.0;
input double          InpMFISellMin                = 18.0;
input bool            InpUseOBVConfirmation        = false;
input int             InpOBVLookbackBars           = 8;
input double          InpOBVMinChange              = 0.0;
input bool            InpUseDIDirectionConfirmation = false;
input double          InpMinDIDifference           = 2.0;
input bool            InpUseADXStrengtheningConfirmation = false;
input int             InpADXStrengthLookbackBars   = 5;
input double          InpADXMinIncrease            = 2.0;
input bool            InpUseCumulativeDeltaProxy   = false;
input int             InpCumulativeDeltaLookbackBars = 12;
input double          InpCumulativeDeltaMinRatio   = 0.18;
input int             InpCumulativeDeltaMinBarsAligned = 7;
input bool            InpUseTickMicrostructure     = false;
input int             InpTickMicroWindowSeconds    = 45;
input int             InpTickMicroMinTicks         = 8;
input double          InpTickMicroMinDirectionRatio = 0.20;
input double          InpTickMicroMinTicksPerSecond = 0.08;
input double          InpTickMicroMinMovePoints    = 10.0;
input bool            InpUseDisplacementCandle     = false;
input double          InpDisplacementMinRangeATR   = 0.90;
input double          InpDisplacementMinBodyPercent = 55.0;
input double          InpDisplacementMaxOppositeWickPercent = 30.0;
input bool            InpUseTickPressureCandle     = false;
input int             InpTickPressureLookbackBars  = 12;
input double          InpTickPressureMinVolumeRatio = 1.20;
input double          InpTickPressureMinCloseLocation = 0.68;
input bool            InpUseTickSpeedImpulse       = false;
input int             InpTickSpeedLookbackBars     = 12;
input double          InpTickSpeedMinRatio         = 1.35;
input double          InpTickSpeedMinBodyPercent   = 45.0;
input double          InpTickSpeedMinRangeATR      = 0.45;
input bool            InpUseCorrelationConfirmation = false;
input string          InpCorrelationSymbol         = "XAGUSD";
input ENUM_TIMEFRAMES InpCorrelationTimeframe      = PERIOD_M15;
input int             InpCorrelationLookbackBars   = 8;
input double          InpCorrelationMinMovePoints  = 20.0;
input ENUM_CORRELATION_CONFIRMATION_MODE InpCorrelationMode = CORRELATION_SAME_DIRECTION;
input bool            InpUseCorrelationRiskScaling = false;
input double          InpCorrelationWeakRiskMultiplier = 0.75;
input double          InpCorrelationConflictRiskMultiplier = 0.50;
...
input double          InpHouseMoneyATRTrailStretchStartCushionPercent = 6.0;
input double          InpHouseMoneyATRTrailStretchFullCushionPercent = 18.0;
input double          InpHouseMoneyATRTrailMaxMultiplier = 2.40;
input double          InpHouseMoneyATRTrailMinMFER = 1.50;
input bool            InpHouseMoneyATRTrailRequireProtectedStop = true;
input bool            InpUseStructureTrailing      = false;
input int             InpTrailStructureLookback    = 8;
input bool            InpUsePartialClose           = false;
input double          InpPartialCloseAtR           = 1.50;
...
input bool            InpUseRPartialProfitLockMonthFilter = false;
input bool            InpRPartialProfitLockTradeJanuary = true;
input bool            InpRPartialProfitLockTradeFebruary = true;
input bool            InpRPartialProfitLockTradeMarch = true;
input bool            InpRPartialProfitLockTradeApril = true;
input bool            InpRPartialProfitLockTradeMay = true;
input bool            InpRPartialProfitLockTradeJune = true;
input bool            InpRPartialProfitLockTradeJuly = true;
input bool            InpRPartialProfitLockTradeAugust = true;
input bool            InpRPartialProfitLockTradeSeptember = true;
input bool            InpRPartialProfitLockTradeOctober = true;
input bool            InpRPartialProfitLockTradeNovember = true;
input bool            InpRPartialProfitLockTradeDecember = true;
input bool            InpUsePostPartialRunnerTPExpansion = false;
input double          InpPostPartialRunnerTPMultiplier = 1.35;
input double          InpPostPartialRunnerMinR      = 0.75;
input bool            InpPostPartialRunnerRequireProtectedStop = true;
input bool            InpUseProtectedRunnerPartialClose = false;
input double          InpProtectedRunnerPartialCloseAtR = 1.00;
input double          InpProtectedRunnerPartialClosePercent = 35.0;
input bool            InpProtectedRunnerPartialMoveStop = true;
input double          InpProtectedRunnerPartialStopLockR = 0.10;
input bool            InpUseProfitLockStop         = false;
input double          InpProfitLockTriggerATR      = 1.50;
input double          InpProfitLockATR             = 0.35;
input bool            InpUseRProfitLockStop        = false;
input double          InpRProfitLockTriggerR       = 1.25;
input double          InpRProfitLockR              = 0.25;
...
input double          InpHouseMoneyMFELockStretchStartCushionPercent = 6.0;
input double          InpHouseMoneyMFELockStretchFullCushionPercent = 18.0;
input double          InpHouseMoneyMFEProfitLockMaxGivebackR = 1.25;
input bool            InpHouseMoneyMFELockStretchRequireProtectedStop = true;
input bool            InpUseRunnerMFEProfitLockPatience = false;
input double          InpRunnerMFEProfitLockGivebackMultiplier = 1.20;
input bool            InpUsePowerTrendMFEProfitLockPatience = false;
input double          InpPowerTrendMFEProfitLockGivebackMultiplier = 1.35;
input bool            InpUseSessionImpulseMFEProfitLockPatience = false;
input double          InpSessionImpulseMFEProfitLockGivebackMultiplier = 1.25;
...
input double          InpHouseMoneyMFEStretchStartCushionPercent = 6.0;
input double          InpHouseMoneyMFEStretchFullCushionPercent = 18.0;
input double          InpHouseMoneyMFEGivebackMaxR = 1.25;
input bool            InpHouseMoneyMFEStretchRequireProtectedStop = true;
input bool            InpUseRunnerExitPatience    = false;
input double          InpRunnerExitPatienceMinR   = 0.50;
input double          InpRunnerExitPatienceMinMFER = 1.00;
input bool            InpRunnerExitPatienceRequireHouseMoney = true;
input bool            InpRunnerExitPatienceRequireProtectedStop = true;
input bool            InpRunnerExitPatienceRequireTrendRegime = true;
input bool            InpRunnerExitPatienceRequireContinuation = true;
input double          InpRunnerExitPatienceMFEGivebackMultiplier = 1.35;
input bool            InpUsePowerTrendRunnerPatience = false;
input double          InpPowerTrendRunnerPatienceMinR = 0.20;
input double          InpPowerTrendRunnerPatienceMinMFER = 0.60;
input double          InpPowerTrendRunnerMFEGivebackMultiplier = 2.00;
input bool            InpPowerTrendRunnerRequireProtectedStop = true;
input bool            InpPowerTrendRunnerRequireContinuation = true;
input bool            InpUseSessionImpulseRunnerPatience = false;
input double          InpSessionImpulseRunnerPatienceMinR = 0.15;
input double          InpSessionImpulseRunnerPatienceMinMFER = 0.50;
input double          InpSessionImpulseRunnerMFEGivebackMultiplier = 1.50;
input bool            InpSessionImpulseRunnerRequireProtectedStop = true;
input bool            InpSessionImpulseRunnerRequireContinuation = true;
input bool            InpUseEarlyMFEReversalExit   = false;
input double          InpEarlyMFEReversalStartR    = 0.60;
input double          InpEarlyMFEReversalExitR     = -0.05;
...
input bool            InpUseMFEFailureMonthFilter  = false;
input bool            InpMFEFailureTradeJanuary    = true;
input bool            InpMFEFailureTradeFebruary   = true;
input bool            InpMFEFailureTradeMarch      = true;
input bool            InpMFEFailureTradeApril      = true;
input bool            InpMFEFailureTradeMay        = true;
input bool            InpMFEFailureTradeJune       = true;
input bool            InpMFEFailureTradeJuly       = true;
input bool            InpMFEFailureTradeAugust     = true;
input bool            InpMFEFailureTradeSeptember  = true;
input bool            InpMFEFailureTradeOctober    = true;
input bool            InpMFEFailureTradeNovember   = true;
input bool            InpMFEFailureTradeDecember   = true;
input bool            InpUseNoFollowThroughExit    = false;
input int             InpNoFollowThroughBars       = 5;
input double          InpNoFollowThroughMinMFER    = 0.20;
input double          InpNoFollowThroughMaxCurrentR = -0.10;
...
input bool            InpUseSessionImpulseFailureExit = false;
input int             InpSessionImpulseFailureBars = 4;
input double          InpSessionImpulseFailureMinMFER = 0.25;
input double          InpSessionImpulseFailureMaxCurrentR = -0.05;
input bool            InpSessionImpulseFailureRequireOppositeCandle = false;
input double          InpSessionImpulseFailureOppositeRangeATR = 0.45;
input double          InpSessionImpulseFailureOppositeBodyPercent = 40.0;
input bool            InpUseAdverseRExit           = false;
input double          InpAdverseExitR              = 0.75;
input bool            InpUseOppositeDisplacementExit = false;
input double          InpOppositeDisplacementExitMinR = -0.25;
input double          InpOppositeDisplacementMinRangeATR = 0.80;
input double          InpOppositeDisplacementMinBodyPercent = 55.0;
input bool            InpUseSpreadShockExit        = false;
input double          InpSpreadShockExitPoints     = 450.0;
input double          InpSpreadShockExitATRPercent = 25.0;
input double          InpSpreadShockExitMaxR       = 0.10;
input bool            InpUseUnderwaterTimeExit     = false;
input int             InpUnderwaterExitBars        = 12;
input double          InpUnderwaterExitMaxR        = -0.25;
input bool            InpUseStagnationExit         = false;
input int             InpStagnationExitBars        = 24;
input double          InpStagnationExitMaxR        = 0.10;
input bool            InpUseReversalPressureExit   = false;
input double          InpReversalPressureMinR      = 0.25;
input int             InpReversalPressureLookbackBars = 12;
input int             InpReversalPressureMinSignals = 2;
input bool            InpUseSmartMoneyThesisBreakExit = false;
input int             InpSmartMoneyExitMinScore    = 5;
input double          InpSmartMoneyExitMaxR        = 0.35;
input int             InpSmartMoneyExitMinHoldBars = 2;
input bool            InpSmartMoneyExitRequireStructure = true;
input bool            InpSmartMoneyExitRequireLiquidityOrImbalance = false;
input bool            InpSmartMoneyExitRequireExecution = true;
input bool            InpUseTimeExit               = false;
input int             InpMaxHoldBars               = 96;
input bool            InpUseEMAExit                = false;
input int             InpExitEMAPeriod             = 50;
input bool            InpUseVolatilityExit         = false;
input double          InpVolatilityExitATRPoints   = 1100;
...
input bool            InpUseSessionOpenGuard       = false;
input int             InpSessionOpenGuardMinutes   = 15;
input bool            InpGuardLondonOpen           = true;
input bool            InpGuardNewYorkOpen          = true;
input bool            InpGuardCustomOpen           = false;
input bool            InpCloseBeforeSessionEnd     = false;
input int             InpSessionEndCloseMinutes    = 15;
input bool            InpCloseAtLondonEnd          = true;
input bool            InpCloseAtNewYorkEnd         = true;
input bool            InpCloseAtCustomEnd          = false;
input bool            InpUseSessionRiskScaling     = false;
input double          InpLondonRiskMultiplier      = 1.00;
input double          InpNewYorkRiskMultiplier     = 1.00;
input double          InpCustomSessionRiskMultiplier = 0.75;
input bool            InpUseDayOfWeekRiskScaling   = false;
input double          InpMondayRiskMultiplier      = 1.00;
input double          InpTuesdayRiskMultiplier     = 1.00;
input double          InpWednesdayRiskMultiplier   = 1.00;
input double          InpThursdayRiskMultiplier    = 1.00;
input double          InpFridayRiskMultiplier      = 0.75;
input bool            InpDisableFridayEvening      = true;
...
input bool            InpUseMonthStartFallbackGuard = false;
input int             InpMonthStartFallbackMinDay  = 3;
input bool            InpUseMonthlyOpenDiscoveryGuard = false;
input int             InpMonthlyOpenGuardMaxDay    = 2;
input int             InpMonthlyOpenGuardStartHour = 6;
input int             InpMonthlyOpenGuardEndHour   = 10;
input int             InpMonthlyOpenGuardOpeningRangeBars = 8;
input int             InpMonthlyOpenGuardMinPriorBars = 3;
input double          InpMonthlyOpenGuardMinBreakoutATR = 0.20;
input double          InpMonthlyOpenGuardMaxOppositeWickPercent = 40.0;
input int             InpMonthlyOpenGuardQualityBypassScore = 14;
input bool            InpMonthlyOpenGuardAllowStrongBOS = true;
input bool            InpMonthlyOpenGuardAllowLiquiditySweep = true;
...
input int             InpJanuaryMinDay             = 1;
input int             InpJanuaryMaxDay             = 31;
input int             InpFebruaryMinDay            = 1;
input int             InpFebruaryMaxDay            = 31;
input int             InpMarchMinDay               = 1;
input int             InpMarchMaxDay               = 31;
input int             InpAprilMinDay               = 1;
input int             InpAprilMaxDay               = 31;
input int             InpMayMinDay                 = 1;
input int             InpMayMaxDay                 = 31;
input int             InpJuneMinDay                = 1;
input int             InpJuneMaxDay                = 31;
input int             InpJulyMinDay                = 1;
input int             InpJulyMaxDay                = 31;
input int             InpAugustMinDay              = 1;
input int             InpAugustMaxDay              = 31;
input int             InpSeptemberMinDay           = 1;
input int             InpSeptemberMaxDay           = 31;
input int             InpOctoberMinDay             = 1;
input int             InpOctoberMaxDay             = 31;
input int             InpNovemberMinDay            = 1;
input int             InpNovemberMaxDay            = 31;
input int             InpDecemberMinDay            = 1;
input int             InpDecemberMaxDay            = 31;
input bool            InpUseMonthDayRiskMultipliers = false;
input double          InpJanuaryDayRiskMultiplier  = 1.00;
input double          InpFebruaryDayRiskMultiplier = 1.00;
input double          InpMarchDayRiskMultiplier    = 1.00;
input double          InpAprilDayRiskMultiplier    = 1.00;
input double          InpMayDayRiskMultiplier      = 1.00;
input double          InpJuneDayRiskMultiplier     = 1.00;
input double          InpJulyDayRiskMultiplier     = 1.00;
input double          InpAugustDayRiskMultiplier   = 1.00;
input double          InpSeptemberDayRiskMultiplier = 1.00;
input double          InpOctoberDayRiskMultiplier  = 1.00;
input double          InpNovemberDayRiskMultiplier = 1.00;
input double          InpDecemberDayRiskMultiplier = 1.00;

//--- News guard
input group "Manual News Filter"
input bool            InpUseManualNewsFilter       = false;
input string          InpNewsTimesCsv              = "";
input int             InpNewsMinutesBefore         = 60;
input int             InpNewsMinutesAfter          = 45;
input bool            InpClosePositionsOnManualNews = false;
...
input string          InpBlockReasonDiagnosticsFile = "Professional_XAUUSD_EA_BlockReasons.csv";
...
input double          InpTesterMinRecoveryFactor   = 0.80;
input double          InpTesterMinSharpeRatio      = 0.00;
input double          InpTesterDrawdownPenalty     = 2.0;
input double          InpTesterTradeCountPenalty   = 0.35;
input double          InpTesterRecoveryPenalty     = 1.0;
input double          InpTesterSharpePenalty       = 0.50;
input double          InpTesterProfitFactorRewardPower = 0.50;
input double          InpTesterRecoveryRewardPower = 0.50;
input double          InpTesterDrawdownRewardPower = 1.00;
input double          InpTesterProtectedProfitNetPower = 1.00;
input double          InpTesterRecoveryFloorPenaltyPower = 2.00;
input double          InpTesterDrawdownExcessPenaltyPower = 2.00;
input double          InpTesterMaxProfitNetPower = 1.35;
input double          InpTesterMaxProfitDrawdownPower = 2.00;
input double          InpTesterMaxProfitQualityPower = 1.00;
