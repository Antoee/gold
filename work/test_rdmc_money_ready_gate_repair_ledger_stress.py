...
SOURCE_SHA256 = "104F1B2D77876FA9856C8BECF7BF2D81DAB187F54BF3ED12C07493BCD6F6D6C8"
CONFIG_SHA256 = "C" * 64
BINARY_SHA256 = "B" * 64
LEGACY_REPORT = (
    ROOT
...
run = subprocess.run(
    [sys.executable, str(ROOT / "work" / "analyze_rdmc_money_ready_gate_repair_ledger_stress.py")],
    cwd=ROOT,
    check=True,
    capture_output=True,
    text=True,
...
with (ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_STRESS_DECISION.csv").open(encoding="utf-8-sig", newline="") as handle:
...
print("RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_STRESS_TEST_PASS cases=12 legacy_trades=127 synthetic_trades=60 mc_trials=300x8")
