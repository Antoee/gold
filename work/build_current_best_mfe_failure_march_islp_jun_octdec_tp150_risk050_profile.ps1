param(
   [string]$BaseProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_JUN_OCTDEC_PROFILE.set",
   [string]$OutProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_JUN_OCTDEC_TP150_RISK050_PROFILE.set"
)
...
$overrides = [ordered]@{
   InpInSessionLiquidityPullbackRiskMultiplier = '0.50||0.50||0||0||N'
   InpInSessionLiquidityPullbackTakeProfitATR = '1.50||1.50||0||0||N'
   InpInSessionLiquidityPullbackMinRR = '0.90||0.90||0||0||N'
}
