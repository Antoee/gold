...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 19:35:55 -05:00`
...
| Elapsed since registration | 1.65 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=103858.0s; identity=True |
