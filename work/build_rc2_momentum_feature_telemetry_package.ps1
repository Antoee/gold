...
Set-PinnedInput $inputs "InpRVLogFileName" "RC2_MOMENTUM_FEATURE_TELEMETRY_RV_2015_2018.csv" -StringValue
Set-PinnedInput $inputs "InpMOLogFileName" "RC2_MOMENTUM_FEATURE_TELEMETRY_MO_2015_2018.csv" -StringValue
Set-PinnedInput $inputs "InpEvidenceSourceHash" $sourceHash -StringValue
Set-PinnedInput $inputs "InpEvidenceRunLabel" "rc2_momentum_feature_telemetry_2015_2018" -StringValue
...
$profileName = "rc2_momentum_feature_telemetry_2015_2018.set"
$profilePath = Join-Path $profileDir $profileName
@($inputs.Keys | Sort-Object | ForEach-Object { $inputs[$_] }) |
   Set-Content -LiteralPath $profilePath -Encoding ASCII
$profileHash = (Get-FileHash -LiteralPath $profilePath -Algorithm SHA256).Hash

$configName = "001_rc2_momentum_feature_telemetry_2015_2018_m1.ini"
$reportName = "rc2_momentum_feature_telemetry_2015_2018_m1"
