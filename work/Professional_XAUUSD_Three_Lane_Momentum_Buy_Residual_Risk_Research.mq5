...
#property description "Research fork with base-eligible momentum-buy residual-risk allocation"
...
input bool   InpMOUseBuyResidualRisk = false;
input double InpMOBuyResidualRiskPercent = 0.20;
...
private:
   ...
   bool OpenPosition(const bool buy, const double atr)
   {
      ...
      if(InpMOUseBuyResidualRisk && buy)
      {
         ...
         lots = LotsForRisk(buy, entryPrice, stopPrice,
