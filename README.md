...
- Newest test result: no new money-ready profile. The latest default-off DGF cushion-risk throttle compiles on current source hash `C23144DDE1F26C29135489FC9DF065FC5B5575C0B3F1B388BECC01E70E5965B4` and passed focused Model4 real-tick testing with `54 / 54` exported reports parsed. `re_may140_late15_dgf_liq_reject1_cush50` reduced worst DD to `20.84%` and made `+$2,770.74`, but 2019 is still red, so it is a safety-shape research candidate only. The higher-profit range-elite lead remains `re_may140_late15_dgf_liq_reject1` at `+$3,218.26`, also not trade-ready.
- Newest stability lead: `r10_pg40_atr085_adapt7`, SHA-256 `CB182D026A62AE499052949F88F514EF7FC67D8C071E9179AB069D29575C59B2`. Model1 yearly 2019-2026 YTD: `+$344.60`, `0` losing years, worst year `+$9.25`, worst DD `7.08%`, `28` trades. Model4 yearly 2019-2026 YTD: `+$263.72`, `1` losing year (`2020`, `-$22.92`), worst DD `7.09%`, `22` trades, `2026 YTD` had `0` real-tick trades. Research lead only, not trade-ready.
