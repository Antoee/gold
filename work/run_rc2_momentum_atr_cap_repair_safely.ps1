...
param(
   ...
   [string]$OutputPrefix = "RC2_MOMENTUM_ATR_CAP_REPAIR_PORTABLE"
)
...
try {
   ...
   Set-Content -LiteralPath $unlock -Value "User-authorized isolated RC2 momentum ATR-cap repair." -Encoding ASCII
   ...
   Set-Content -LiteralPath $hardLock -Value "Restored after isolated RC2 momentum ATR-cap repair." -Encoding ASCII
}
