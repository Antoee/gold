param(
   ...
   [string]$PackageManifestPath = "outputs\INDEPENDENT_M15_DAILY_VWAP_CONTINUATION_DISCOVERY_MODEL1_PACKAGE_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\INDEPENDENT_M15_DAILY_VWAP_CONTINUATION_DISCOVERY_MODEL1_PACKAGE.md"
)
...
function New-BaseInputs {
   $inputs = [ordered]@{}
   $defaults = [ordered]@{
      InpAllowedSymbol = "XAUUSD"; InpMagicNumber = "26071785"; InpUseSymbolSafetyLock = "true"
      InpUseRealAccountSafetyLock = "true"; InpAllowRealAccountTrading = "false"; InpRealAccountApprovalCode = "DISABLED"
      InpSignalTimeframe = "15"; InpPullbackLookbackBars = "3"; InpMinimumVWAPBars = "4"
      InpVWAPTouchToleranceATR = "0.05"; InpMaximumCloseDistanceATR = "0.75"
      InpRequirePriorCloseBeyondVWAP = "true"
      ...
      InpRequirePreviousHighLowBreak = "true"
      ...
      InpLogTrades = "false"; InpLogFileName = "Independent_XAUUSD_M15_Daily_VWAP_Continuation_Trades.csv"
...
& (Join-Path $PSScriptRoot "test_independent_m15_daily_vwap_continuation_source.ps1") | Out-Null
...
$variants = @(
   [pscustomobject]@{ Name = "m15dvc_center"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_pb2"; PullbackBars = "2"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_pb4"; PullbackBars = "4"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_adx16"; PullbackBars = "3"; MinimumADX = "16.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_adx20"; PullbackBars = "3"; MinimumADX = "20.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_adx22"; PullbackBars = "3"; MinimumADX = "22.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_tp150"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "1.50"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_tp250"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.50"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_body45"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.00"; Body = "45.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_touch_only"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "false"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_volume105"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "true"; VolumeRatio = "1.05"; SessionStart = "6"; SessionEnd = "18" },
   [pscustomobject]@{ Name = "m15dvc_session7_17"; PullbackBars = "3"; MinimumADX = "18.0"; TPR = "2.00"; Body = "35.0"; PriorBeyond = "true"; UseVolume = "false"; VolumeRatio = "1.05"; SessionStart = "7"; SessionEnd = "17" }
)
$windows = @(
...
$rank = 0
$candidateRank = 0
$stopRule = "Discovery only: require both disjoint eras positive, continuous PF at least 1.30, at least 120 continuous trades, DD at or below 3%, and support from at least two adjacent VWAP/pullback/ADX/payoff shapes before opening 2021-2026."
foreach($variant in $variants) {
   ...
   Set-InputLine -Inputs $inputs -Name "InpMinimumSignalBodyPercent" -Value $variant.Body
   Set-InputLine -Inputs $inputs -Name "InpRequirePriorCloseBeyondVWAP" -Value $variant.PriorBeyond
   Set-InputLine -Inputs $inputs -Name "InpUseSignalVolumeFilter" -Value $variant.UseVolume
   Set-InputLine -Inputs $inputs -Name "InpMinimumSignalVolumeRatio" -Value $variant.VolumeRatio
   ...
   Set-InputLine -Inputs $inputs -Name "InpEvidenceRunLabel" -Value "independent_m15_daily_vwap_continuation_discovery_model1"
   ...
   foreach($window in $windows) {
      ...
      $queueRows.Add([pscustomobject]@{
         ...
         SourceType = "independent_m15_daily_vwap_continuation"; SourceRank = 1; Phase = "discovery_model1"
         ...
         PullbackLookbackBars = $variant.PullbackBars; MinimumADX = $variant.MinimumADX
         TakeProfitR = $variant.TPR; MinimumSignalBodyPercent = $variant.Body
         RequirePriorCloseBeyondVWAP = $variant.PriorBeyond; UseSignalVolumeFilter = $variant.UseVolume
      ...
      $runRows.Add([pscustomobject]@{
         ...
         PhaseLabel = "Independent M15 daily-VWAP continuation discovery Model1"; Window = $window.Name; Model = 1; Deposit = 10000
...
$md.Add("# Independent M15 Daily-VWAP Continuation Discovery Package")
$md.Add("")
...
$md.Add("")
$md.Add('Every profile requires an aligned and rising/falling H1 50/200 EMA regime, bounded H1 ADX, a pullback through the current day anchored VWAP, and a completed directional reclaim candle confirmed by OHLC body, close location, previous-bar progress, and optional tick volume. Stops sit behind the pullback structure, reject distances above `$8`, use broker-accurate `OrderCalcProfit` sizing at `0.10%` risk, and keep real-account trading disabled.')
