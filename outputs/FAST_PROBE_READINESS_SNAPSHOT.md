...
|---|---|---:|---|---|
| STRESS_SMOKE | WAITING_FOR_REPORTS | 0 | missing=outputs\STRESS_SMOKE_DECISION.csv | Run/import the 2-row stress smoke reports first. |
| STRESS_MICRO | WAITING_FOR_REPORTS | 0 | missing=outputs\MICRO_TEST_DECISION.csv | Run/import stress micro reports after stress smoke passes. |
...
| NEWS_FILTER_PROBE | WAITING_FOR_REPORTS | 0 | missing=outputs\NEWS_FILTER_PROBE_DECISION.csv | Run/import news-filter probe reports. |
