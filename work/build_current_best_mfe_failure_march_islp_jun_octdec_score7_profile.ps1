param(
   ...
   [string]$OutProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_JUN_OCTDEC_SCORE7_PROFILE.set"
)
...
$overrides = [ordered]@{
   InpInSessionLiquidityPullbackMinScore = '7||7||0||0||N'
}
