...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 07:24:39 -05:00`
...
| Elapsed since registration | 3.14 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=232781.8s; identity=True |
