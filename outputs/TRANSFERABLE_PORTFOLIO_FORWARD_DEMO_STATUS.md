...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 09:39:00 -05:00`
...
| Elapsed since registration | 1.24 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=68042.9s; identity=True |
