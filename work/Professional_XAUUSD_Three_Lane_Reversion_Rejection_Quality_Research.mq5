...
#property description "Research fork with completed-bar body-and-wick reversion allocation"
...
input bool   InpRVUseStrongRejectionQuality = false;
input double InpRVStrongSignalMinimumDirectionalWickPercent = 25.0;
...
bool InputsValid()
{
   ...
   if(InpRVATRPeriod < 2 || InpRVADXPeriod < 2 || InpRVRSIPeriod < 2 ||
      ...
      (InpRVUseStrongRejectionQuality &&
       (!InpRVUseStrongSignalRisk ||
        InpRVStrongSignalMinimumDirectionalWickPercent < InpRVMinimumWickPercent ||
        InpRVStrongSignalMinimumDirectionalWickPercent > 95.0)) ||
