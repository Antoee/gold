...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 04:20:39 -05:00`
...
| Elapsed since registration | 3.02 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=221741.2s; identity=True |
