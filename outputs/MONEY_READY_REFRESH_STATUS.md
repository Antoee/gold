...
| reproducibility-bundle | PASS | rows=72; pass=72; pending=0; fail=0; zipExists=True | outputs\TRADE_READY_REPRODUCIBILITY_BUNDLE.md | Use this local source/profile hash freeze for reproducibility; it does not replace the live-readiness GitHub sync gate. |
