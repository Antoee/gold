...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 08:00:47 -05:00`
...
| Elapsed since registration | 3.17 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=234949.1s; identity=True |
