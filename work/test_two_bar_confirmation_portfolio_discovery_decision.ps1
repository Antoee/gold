param(
   ...
   [string]$DecisionPath = "outputs\TWO_BAR_CONFIRMATION_PORTFOLIO_DISCOVERY_DECISION.csv",
...
if(@($summary | Where-Object { $_.Candidate -eq 'tbc_fixed_control' -and $_.Decision -ne 'CONTROL_ONLY' }).Count -ne 0) { throw "Unchanged control became promotable." }
