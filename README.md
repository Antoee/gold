...
- Newest test result: no new best. The `range_elite_risk_shape_probe` aligned Model1 run parsed `80 / 80` reports. `re_may140` / `re_blockliq_may140` had the best fast-screen total at `+$3,015.75`, but 2019, 2021, and 2023 were still red, so it is rejected. The important improvement is infrastructure: current source hash `AF34F307DECFA45F53312DD53606E70141508973CEF60D30480779694396D7AC` compiles with `308` exposed tester inputs instead of failing MT5 with `1826`.
