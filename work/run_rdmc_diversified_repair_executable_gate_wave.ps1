...
param(
   ...
   [string]$PlanCsv = "outputs\RDMC_DIVERSIFIED_REPAIR_EXECUTABLE_GATE_RUN_PLAN.csv",
   [string]$PlanMarkdown = "outputs\RDMC_DIVERSIFIED_REPAIR_EXECUTABLE_GATE_RUN_PLAN.md"
)
