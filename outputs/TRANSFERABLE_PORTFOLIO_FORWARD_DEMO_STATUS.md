...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 12:32:45 -05:00`
...
| Elapsed since registration | 3.36 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=251267.3s; identity=True |
