...
#property description "Research fork with completed-bar strong-signal risk and a noncompounding risk budget"
...
input bool   InpUseNoncompoundingRiskBudget = false;
...
double RiskBudgetCapital()
{
   ...
   if(!InpUseNoncompoundingRiskBudget)
      return equity;
   if(InpExpectedInitialBalance <= 0.0)
      return 0.0;
