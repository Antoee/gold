...
MANIFEST = ROOT / "outputs" / "RDMC_ENTRY_REGIME_REWRITE_V1_WAVE_01_MANIFEST.csv"
RESULTS = ROOT / "outputs" / "RDMC_ENTRY_REGIME_REWRITE_V1_WAVE_01_RESULTS.csv"
EVALUATION = ROOT / "outputs" / "RDMC_ENTRY_REGIME_REWRITE_V1_WAVE_01_EVALUATION.csv"
DECISION = ROOT / "outputs" / "RDMC_ENTRY_REGIME_REWRITE_V1_DECISION_FIXTURE.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_ENTRY_REGIME_REWRITE_V1_DECISION.md"
EXPECTED_MANIFEST = "CEB86C9643FD5997EDDF0E93449CE62DCD06B449BA578E5F5A99191AA2263C34"
EXPECTED_SOURCE = "41768D6A8C21A49B0B8465F90A4C3C254CA0FC714910AB6AAFBDE9B8D4402FED"
EXPECTED_PROFILE = "D7C882EA36B34AE919A48407C7CA748579BE5D7D1C28103D688471C6AF1E1BD9"
...
def main() -> int:
    ...
    lines = [
        "# RDMC Entry/Regime Rewrite v1 Decision",
        "",
