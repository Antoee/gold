...
- **Status:** `FAIL`
- **Updated:** `2026-07-17 14:57:56 -05:00`
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=778.0s; identity=True |
...
| Minimum observation sample | PENDING | days=0.46/90; trades=0/30 |
