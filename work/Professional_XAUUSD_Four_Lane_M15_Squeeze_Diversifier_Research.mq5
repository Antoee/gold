...
#property description "Research fork with a default-off M15 volatility-squeeze diversifier lane"
...
private:
   ...
   bool OpenPosition(const bool buy, const double atr, const double rawStop)
   {
      ...
      double stopPrice = NormalizeDouble(buy ? entryPrice - stopDistance
                                             : entryPrice + stopDistance, _Digits);
      double takeProfit = NormalizeDouble(buy ? entryPrice + InpSQTakeProfitR * stopDistance
      ...
      WriteEvidenceEvent(m_logHandle, "m15_sq_b8", "entry", ticket,
                         buy ? "buy" : "sell", lots, entryPrice, stopPrice, 0.0,
...
bool InputsValid()
{
   ...
   if(InpSQSqueezeBars < 2 || InpSQSqueezeBars > 12 ||
      ...
      InpSQTakeProfitR <= 0.0 || InpSQBreakEvenTriggerR < 0.0 ||
