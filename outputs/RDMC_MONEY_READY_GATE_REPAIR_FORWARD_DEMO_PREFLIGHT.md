...
| static-blocker-identity | True | Blockers: none. |
| static-trade-readiness | True | Status=PASS; blockers=none. |
| primary-executable-gate | False | status=EXECUTABLE_GATE_REJECTED_WAVE_01; identity=True. |
