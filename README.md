...
Last updated: 2026-07-14 UTC after hidden local MT5 first-pass testing of `trade_ready_conservative`, `money_ready`, locked LowATR risk-shape candidates, a 33-variant R20 opportunity sweep, yearly splits, a 22-variant R10 drawdown-reduction sweep, a 5-profile Model4 real-tick shortlist, an 8-year Model1 OOS yearly pass for the R10 branches, and the DGF peak-trail continuous follow-up. There is still no newly validated trade-ready best profile. The strict/stability branch remains `lowatr_exit_peak_r20` style evidence: `+$464.86`, `18.40%/yr`, PF `6.7890`, recovery `5.1411`, and `5.81%` drawdown on the fast continuous screen, but it is too sparse and weak in 2025. The current DGF high-profit continuous research lead is `lossblock_highprofit_peaktrail_off`: Model4 `+$1,915.83`, `25.45%/yr`, PF `1.72`, recovery `2.02`, and `24.58%` max equity drawdown. The more efficient older R10 high-profit branch remains lower drawdown at Model4 `+$1,564.01` with `10.64%` drawdown. The drawdown fallback is `r10_profit_guard40`: Model4 `+$1,000.97`, `39.61%/yr`, PF `3.4058`, recovery `8.5240`, and `7.76%` drawdown. The OOS yearly pass rejected all R10 branches as money-ready because 2019/2021 and other older windows went red and yearly drawdown reached `12-14%`.
