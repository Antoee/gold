...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 02:36:07 -05:00`
...
| Elapsed since registration | 2.94 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=215469.8s; identity=True |
