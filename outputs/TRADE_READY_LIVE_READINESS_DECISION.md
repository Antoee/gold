...
| model4-validation-decision | PENDING | Conservative validation decision has 0 FAIL and 0 PENDING gates | rows=27; pass=2; pending=25; fail=0 | outputs\TRADE_READY_CONSERVATIVE_VALIDATION_DECISION.csv | Return and import all staged Model4/fast/stress/broker-proxy reports. |
