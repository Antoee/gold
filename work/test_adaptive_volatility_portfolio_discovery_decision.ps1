param(
   ...
   [string]$DecisionPath = "outputs\ADAPTIVE_VOLATILITY_PORTFOLIO_DISCOVERY_DECISION.csv",
...
if(@($summary | Where-Object { $_.Candidate -eq 'avp_fixed_control' -and $_.Decision -ne 'CONTROL_ONLY' }).Count -ne 0) { throw "Fixed-risk control became promotable." }
