...
SOURCE = ROOT / "outputs" / "rdmc_hard_lane_risk_v4_package" / "source" / "Professional_XAUUSD_EA.mq5"
PROFILE = ROOT / "outputs" / "rdmc_hard_lane_risk_v4_package" / "profiles" / "rdmc_hard_lane_risk_v4.set"
PREDECESSOR = ROOT / "outputs" / "rdmc_momentum_loss_decay_v3_package" / "source" / "Professional_XAUUSD_EA.mq5"
...
EXPECTED_PREDECESSOR = "59A872EB7D4DA5159CDCAED791A51DF1C118F3E34EE460F0242BA486D7977370"
...
require(profile["InpEvidenceProfileId"] == "rdmc_hard_lane_risk_v4", "profile id changed")
...
print("RDMC_HARD_LANE_RISK_V4_TEST_PASS inputs=601 identity=exact predecessor=unchanged")
