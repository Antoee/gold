...
$rvFile = "OPERATIONAL_HARDENING_RC2_RV_MODEL1_EVENTS.csv"
$moFile = "OPERATIONAL_HARDENING_RC2_MO_MODEL1_EVENTS.csv"
...
& (Join-Path $PSScriptRoot "run_single_profile_package_hidden_safely.ps1") `
   -ManifestPath "outputs\OPERATIONAL_HARDENING_RC2_MODEL1_PACKAGE_MANIFEST.csv" `
   -QueueManifestPath "outputs\OPERATIONAL_HARDENING_RC2_MODEL1_QUEUE.csv" `
   -OutStem "OPERATIONAL_HARDENING_RC2_MODEL1" `
   ...
   -CompileLogPath "outputs\OPERATIONAL_HARDENING_RC2_MODEL1_COMPILE.log" `
   -CommonDiagnosticFile $rvFile `
   -DiagnosticOutputPath "outputs\OPERATIONAL_HARDENING_RC2_RV_MODEL1_EVENTS.csv" | Out-Null
...
$moOutput = Join-Path $repo "outputs\OPERATIONAL_HARDENING_RC2_MO_MODEL1_EVENTS.csv"
...
[pscustomobject]@{
   ...
   ReversionEvidenceSha256 = (Get-FileHash -LiteralPath (Join-Path $repo "outputs\OPERATIONAL_HARDENING_RC2_RV_MODEL1_EVENTS.csv") -Algorithm SHA256).Hash
