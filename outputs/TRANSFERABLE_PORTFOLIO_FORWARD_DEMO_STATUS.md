...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 09:32:26 -05:00`
...
| Elapsed since registration | 2.23 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=154048.3s; identity=True |
