...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 05:53:29 -05:00`
...
| Elapsed since registration | 3.08 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=227311.3s; identity=True |
