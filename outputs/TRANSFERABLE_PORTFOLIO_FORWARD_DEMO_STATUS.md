...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 11:52:26 -05:00`
...
| Elapsed since registration | 3.33 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=248848.7s; identity=True |
