...
- **Status:** `FAIL`
- **Updated:** `2026-07-17 13:13:19 -05:00`
...
| Sentinel heartbeat freshness and identity | PASS | present=True; valid=True; fresh=True; age=21.2s; identity=True |
...
| Minimum observation sample | PENDING | days=0.39/90; trades=0/30 |
