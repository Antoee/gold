...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 14:15:34 -05:00`
...
| Elapsed since registration | 1.43 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=84636.3s; identity=True |
