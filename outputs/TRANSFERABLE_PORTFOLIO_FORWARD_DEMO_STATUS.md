...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 10:06:52 -05:00`
...
| Elapsed since registration | 3.26 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=242514.0s; identity=True |
