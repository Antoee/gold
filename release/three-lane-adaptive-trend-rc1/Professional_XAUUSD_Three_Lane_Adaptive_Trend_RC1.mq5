...
#property description "Risk-first three-lane XAUUSD portfolio with capped reversion, original momentum and adaptive H4 trend"
...
private:
   ...
   bool OpenPosition(const bool buy, const double atr)
   {
      ...
      if(!opened)
         return false;
      RegisterRiskForNewestPosition(stopDistance);
      WriteEvidenceEvent(m_logHandle, "atb_h4_d1", "entry", m_trade.ResultOrder(),
                         buy ? "buy" : "sell", lots, entryPrice, stopPrice, 0.0,
