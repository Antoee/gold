...
The compression-breakout profile remains one of the active FMLR probe profiles. After the session-range breakout follow-up, the offline package now prepares 14 profiles across 12 windows, or `168` total configs.
