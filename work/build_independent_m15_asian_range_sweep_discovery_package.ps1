param(
   ...
   [string]$PackageManifestPath = "outputs\INDEPENDENT_M15_ASIAN_RANGE_SWEEP_DISCOVERY_MODEL1_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\INDEPENDENT_M15_ASIAN_RANGE_SWEEP_DISCOVERY_MODEL1_PACKAGE.md"
)
...
function New-BaseInputs {
   $inputs = [ordered]@{}
   $defaults = [ordered]@{
      InpAllowedSymbol = "XAUUSD"; InpMagicNumber = "26071931"; InpUseSymbolSafetyLock = "true"
      InpUseRealAccountSafetyLock = "true"; InpAllowRealAccountTrading = "false"; InpRealAccountApprovalCode = "DISABLED"
      InpSignalTimeframe = "15"; InpAsianRangeStartHour = "0"; InpAsianRangeEndHour = "6"
      InpMinimumAsianRangeBars = "16"; InpMinimumAsianRangeATR = "1.00"; InpMaximumAsianRangeATR = "8.00"
      InpMinimumSweepATR = "0.10"; InpMinimumSweepPoints = "20.0"; InpMaximumSweepATR = "0.75"
      InpMinimumReclaimATR = "0.00"; InpMinimumWickToBodyRatio = "1.00"; InpMinimumBodyPercent = "10.0"
      InpMinimumCloseLocation = "0.60"; InpRequireDirectionCandle = "true"; InpRequireFreshSweep = "true"
      InpAllowBuy = "true"; InpAllowSell = "true"; InpUseTickVolumeFilter = "false"
      InpVolumeLookbackBars = "20"; InpMinimumVolumeRatio = "1.10"; InpUseTrendEMAFilter = "false"
      InpTrendTimeframe = "16385"; InpTrendEMAPeriod = "100"; InpTrendEMASlopeBars = "3"
      InpRequireTrendAlignment = "true"; InpUseMaximumADXFilter = "false"; InpADXPeriod = "14"
      InpMaximumADX = "28.0"; InpUseVolatilityFilter = "true"; InpMinimumATRPercent = "0.03"
      InpMaximumATRPercent = "2.50"; InpATRPeriod = "20"; InpStopBufferATR = "0.10"
      InpMinimumStopATR = "0.25"; InpMaximumStopATR = "2.00"; InpMaximumStopPriceDistance = "10.00"
      InpUseFixedTakeProfit = "true"; InpTakeProfitR = "1.50"; InpUseAsianMidpointTarget = "false"
      InpMinimumMidpointTargetR = "1.00"; InpUseBreakEven = "true"; InpBreakEvenTriggerR = "0.80"
      ...
      InpUseSessionFilter = "true"; InpEntryStartHour = "6"; InpEntryEndHour = "12"
      ...
      InpLogFileName = "Independent_XAUUSD_M15_Asian_Range_Sweep_Trades.csv"
...
& (Join-Path $PSScriptRoot "test_independent_m15_asian_range_sweep_source.ps1") | Out-Null
...
$variants = @(
   [pscustomobject]@{ Name = "ars_center"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_sweep05"; Sweep = "0.05"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_sweep15"; Sweep = "0.15"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_reclaim05"; Sweep = "0.10"; Reclaim = "0.05"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_wick15"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.50"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_volume105"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "true"; VolumeRatio = "1.05"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_adx24"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "true"; MaxAdx = "24.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_rr20"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "2.00"; Midpoint = "false"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_midpoint"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "true"; EntryEnd = "12" },
   [pscustomobject]@{ Name = "ars_entry10"; Sweep = "0.10"; Reclaim = "0.00"; Wick = "1.00"; Volume = "false"; VolumeRatio = "1.10"; AdxFilter = "false"; MaxAdx = "28.0"; TPR = "1.50"; Midpoint = "false"; EntryEnd = "10" }
)
...
$rank = 0
$candidateRank = 0
$runLabel = "independent_m15_asian_range_sweep_discovery_model1"
$stopRule = "Pre-2021 only: center plus at least two one-factor neighbors must each have both disjoint eras positive, continuous PF >=1.20, trades >=100, DD <=3.00%, positive payoff, and return/DD >=1.00."
...
foreach($variant in $variants) {
   ...
   Set-InputLine -Inputs $inputs -Name "InpUseMaximumADXFilter" -Value $variant.AdxFilter
   ...
   Set-InputLine -Inputs $inputs -Name "InpUseAsianMidpointTarget" -Value $variant.Midpoint
   Set-InputLine -Inputs $inputs -Name "InpEntryEndHour" -Value $variant.EntryEnd
   ...
   foreach($window in $windows) {
      ...
      $queueRows.Add([pscustomobject]@{
         ...
         SourceType = "independent_m15_asian_range_sweep"; Phase = "discovery_model1"
         ...
         MinimumSweepATR = $variant.Sweep; MinimumReclaimATR = $variant.Reclaim
         WickToBodyRatio = $variant.Wick; UseTickVolumeFilter = $variant.Volume
         MinimumVolumeRatio = $variant.VolumeRatio; UseMaximumADXFilter = $variant.AdxFilter
         MaximumADX = $variant.MaxAdx; TakeProfitR = $variant.TPR
         UseAsianMidpointTarget = $variant.Midpoint; EntryEndHour = $variant.EntryEnd; StopRule = $stopRule
      }) | Out-Null
...
$md.Add("# Independent M15 Asian-Range Sweep Discovery Package")
$md.Add("")
...
$md.Add("")
$md.Add("The signal requires a fresh sweep and reclaim of the completed 00:00-06:00 broker-time range, a rejection candle, a structure stop beyond the sweep, and no more than one trade per day.")
$md.Add("")
