...
**2026-07-17 update: no new best was promoted. The first forward attachment was invalidated before its first trade because the demo account had the wrong starting balance. A new M15 dual-regime portfolio passed 2015-2020 discovery but every frozen profile lost in the untouched 2024-2026 YTD window, so it was rejected before Model 4.**
