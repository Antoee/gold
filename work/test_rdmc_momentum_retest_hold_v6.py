...
SOURCE = ROOT / "outputs" / "rdmc_momentum_retest_hold_v6_package" / "source" / "Professional_XAUUSD_EA.mq5"
PROFILE = ROOT / "outputs" / "rdmc_momentum_retest_hold_v6_package" / "profiles" / "rdmc_momentum_retest_hold_v6.set"
PREDECESSOR = ROOT / "outputs" / "rdmc_momentum_breakout_retest_v5_package" / "source" / "Professional_XAUUSD_EA.mq5"
...
EXPECTED_PREDECESSOR = "98578500821366CE7E89B0691BF47695733A492283E32FDC4B38CC5F216F974C"
...
require(len(profile) == 612, f"expected 612 profile inputs, found {len(profile)}")
...
require(profile["InpEvidenceProfileId"] == "rdmc_momentum_retest_hold_v6", "profile id changed")
...
require(profile["InpMOUseBreakoutHoldEntry"] == "true", "breakout-hold mechanism is not enabled")
...
print("RDMC_MOMENTUM_RETEST_HOLD_V6_TEST_PASS inputs=612 identity=exact predecessor=unchanged")
