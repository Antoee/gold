...
MANIFEST = ROOT / "outputs" / "RDMC_TIERED_MOMENTUM_V7_GATE_MANIFEST.csv"
RESULTS = ROOT / "outputs" / "RDMC_TIERED_MOMENTUM_V7_GATE_RESULTS.csv"
EVALUATION = ROOT / "outputs" / "RDMC_TIERED_MOMENTUM_V7_GATE_EVALUATION.csv"
DECISION = ROOT / "outputs" / "RDMC_TIERED_MOMENTUM_V7_DECISION_FIXTURE.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_TIERED_MOMENTUM_V7_DECISION.md"
EXPECTED_MANIFEST = "80BD25AE1E3D88B5D758AA70F74FB673EE1FB8A09CC1AEF356CA50F4DC3D4C1D"
...
def main() -> int:
    ...
    lines = [
        "# RDMC Tiered Momentum v7 Decision",
        "",
