...
MANIFEST = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_VALIDATION_MANIFEST.csv"
SPECIFICATION = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_SPECIFICATION.csv"
RESULTS = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_VALIDATION_RESULTS.csv"
PRIMARY_GATE_DECISION = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_DECISION.csv"
PRIMARY_RESULTS = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_RESULTS.csv"
LEDGER_DECISION = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_STRESS_DECISION.csv"
EVALUATION_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_VALIDATION_EVALUATION.csv"
DECISION_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_VALIDATION_DECISION.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_SECOND_BROKER_VALIDATION_DECISION.md"
REPORT_ROOT = ROOT / "outputs" / "rdmc_money_ready_gate_repair_second_broker_validation_package" / "reports_here"
REPO_LOCK = ROOT / "work" / "MT5_LOCAL_LAUNCH_DISABLED.lock"
OUTER_LOCK = ROOT.parent / "MT5_LOCAL_LAUNCH_DISABLED.lock"

EXPECTED_MANIFEST_SHA256 = "30A508459E0C408BFF9A905F5C9AEB01AF9D411C39165734F197CC2928CE6CB5"
...
def main() -> int:
    ...
    lines = [
        "# RDMC Money-Ready Gate Repair Second-Broker Validation Decision",
        "",
