...
param(
   ...
   [string]$PackageDir = 'outputs\three_lane_momentum_adaptive_risk_reallocation_discovery_model1_package',
...
Set-FixedInput $base 'InpEvidenceRunLabel' 'three_lane_momentum_adaptive_risk_reallocation_discovery_model1' -StringValue
Set-FixedInput $base 'InpLogTrades' 'false'
Set-FixedInput $base 'InpShowDashboard' 'false'

$variants = @(
   [pscustomobject]@{Name='marr_control_015_015';Role='control';MomentumRisk='0.15';AdaptiveRisk='0.15'},
   [pscustomobject]@{Name='marr_016_014';Role='lower_boundary';MomentumRisk='0.16';AdaptiveRisk='0.14'},
   [pscustomobject]@{Name='marr_0175_0125';Role='lower_support';MomentumRisk='0.175';AdaptiveRisk='0.125'},
   [pscustomobject]@{Name='marr_019_011';Role='upper_support';MomentumRisk='0.19';AdaptiveRisk='0.11'},
   [pscustomobject]@{Name='marr_center_020_010';Role='center';MomentumRisk='0.20';AdaptiveRisk='0.10'}
)
$windows = @(
...
foreach($variant in $variants) {
   ...
   foreach($window in $windows) {
      ...
      $rows.Add([pscustomobject][ordered]@{
         ...
         Phase='momentum_adaptive_risk_reallocation_discovery_model1';Window=$window.Name
         ...
         ReversionRiskPercent='0.45';DeclaredLaneRiskSumPercent='0.75';MaximumPortfolioOpenRiskPercent='0.75'
