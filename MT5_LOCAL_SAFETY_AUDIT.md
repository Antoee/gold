...
| Runner scripts | All MT5 runner scripts source the launch guard | True | Runner scripts checked: 56; unguarded: 0 | Add the launch guard near the top of each runner. |
