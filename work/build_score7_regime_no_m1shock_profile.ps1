param(
   ...
   [string]$OutProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_JUN_OCTDEC_SCORE7_REGIME_NO_M1SHOCK_PROFILE.set"
)
...
$overrides = [ordered]@{
   ...
   InpUseM1SpreadShockGuard     = 'false||false||0||0||N'
