...
#property description "Research fork with outcome-independent momentum same-side exit cooldown"
...
private:
   ...
   void TryEntry()
   {
      ...
      if(adjustedRiskReward < MathMax(0.0, InpRVMinimumRiskReward))
         return;
...
bool InputsValid()
{
   ...
   if(InpRVATRPeriod < 2 || InpRVADXPeriod < 2 || InpRVRSIPeriod < 2 ||
      ...
      (InpRVUseStrongSignalRewardQuality &&
       (!InpRVUseStrongSignalRisk ||
        InpRVStrongSignalMinimumRiskReward < InpRVMinimumRiskReward ||
        InpRVStrongSignalMinimumRiskReward > 10.0)) ||
