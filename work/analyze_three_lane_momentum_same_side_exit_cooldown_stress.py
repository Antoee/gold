#!/usr/bin/env python3
"""Run identity-bound risk, cost, and clustered Monte Carlo stress for MSEC."""
...
RUN_ATTESTATION = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_RUN_ATTESTATION.csv"
RESULTS = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_RESULTS.csv"
ANNUAL_DECISION = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_ANNUAL_MODEL4_DECISION.csv"
PROFILE = ROOT / "outputs" / "three_lane_momentum_same_side_exit_cooldown_model4_package" / "profiles" / "msec_center_060.set"
REPORT_ROOT = ROOT / "outputs" / "three_lane_momentum_same_side_exit_cooldown_model4_package" / "reports_here"
REPORT_NAME = "msec_center_060_continuous_2015_2026_m4"
REPORT = REPORT_ROOT / f"{REPORT_NAME}.htm"
IDENTITY = REPORT_ROOT / f"{REPORT_NAME}.identity.json"
LEDGER = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_CONTINUOUS_TRADES.csv"
RISK_AUDIT = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_RISK_AUDIT.csv"
OUT_COST = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_COST_STRESS.csv"
OUT_MC = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_MONTE_CARLO.csv"
OUT_DECISION_CSV = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_STRESS_DECISION.csv"
OUT_DECISION_MD = ROOT / "outputs" / "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_MODEL4_STRESS_DECISION.md"

EXPECTED_RUN_ATTESTATION_SHA256 = "1F37B08CC821F53676DE572EF65A823AE79FE04EDA71A06E89F0EBF071807705"
EXPECTED_ANNUAL_DECISION_SHA256 = "B582F1E59B517E1C5FC66645833E8FCC762CB61589159B1F86A8F44E246D5B29"
EXPECTED_SOURCE_SHA256 = "B6810B305549968E2273DAAF736A63759FE5C16F3B416F5C69E39840FBE5173E"
EXPECTED_PROFILE_SHA256 = "ACFCE73E2A48723334CC416715F047E3CEA87018D46B12B8A6CB0663E025BA1C"
EXPECTED_BINARY_SHA256 = "D85336B07A8C34C4567537D5C9BD7CDC0F31D0B8ED67B73BAC1088B19E126123"
EXPECTED_REPORT_SHA256 = "470C44F1B2426768379BF70706CE164F25A572F6B92CFEEBE54F0B3A1513EDF4"
EXPECTED_TRADES = 400
EXPECTED_NET = 2492.25
...
attestation_matches = [
    ...
    if row["Candidate"] == "msec_center_060" and row["Window"] == "continuous_2015_2026"
]
...
print(
    "THREE_LANE_MOMENTUM_SAME_SIDE_EXIT_COOLDOWN_STRESS_PASS "
