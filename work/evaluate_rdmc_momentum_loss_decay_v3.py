...
MANIFEST = ROOT / "outputs" / "RDMC_MOMENTUM_LOSS_DECAY_V3_WAVE_01_MANIFEST.csv"
RESULTS = ROOT / "outputs" / "RDMC_MOMENTUM_LOSS_DECAY_V3_WAVE_01_RESULTS.csv"
EVALUATION = ROOT / "outputs" / "RDMC_MOMENTUM_LOSS_DECAY_V3_WAVE_01_EVALUATION.csv"
DECISION = ROOT / "outputs" / "RDMC_MOMENTUM_LOSS_DECAY_V3_DECISION_FIXTURE.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_MOMENTUM_LOSS_DECAY_V3_DECISION.md"
EXPECTED_MANIFEST = "1C4FD229123D3423772B1D8EF24A373C9745A892169A94682E895950D771120C"
...
def main() -> int:
    ...
    lines = [
        "# RDMC Momentum Loss Decay v3 Decision",
        "",
