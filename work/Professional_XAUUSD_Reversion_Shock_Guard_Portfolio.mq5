...
#property description "Research fork adding a modular rejection-body guard to the hardened XAUUSD portfolio"
...
input bool   InpRVUseMinimumBodyGate = false;
input double InpRVMinimumBodyPercent = 25.0;
