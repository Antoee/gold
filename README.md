...
A broker-accurate H4 Donchian channel-trend strategy then produced a genuine 2015-2020 discovery plateau: the strongest frozen profile made `+$328.77`, PF `2.12`, on `76` trades with `0.76%` drawdown. It decisively failed its predeclared 2021-2026 strategy-specific holdout. All `36 / 36` reports completed, but every frozen profile produced only one holdout trade, with no trades at all in 2021, 2022, 2024, 2025, or 2026 YTD. At the intended `$10,000` balance and `0.10%` risk, its wide two-ATR H4 stop is likely below the broker's minimum-lot feasibility during recent gold volatility. The EA correctly refuses that trade instead of oversizing it. The family was rejected without Model 4 or post-holdout retuning. See `outputs/INDEPENDENT_H4_CHANNEL_TREND_DECISION.md`.
