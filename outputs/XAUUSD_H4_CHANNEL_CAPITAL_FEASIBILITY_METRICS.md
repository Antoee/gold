...
- Queue manifest: `outputs\XAUUSD_H4_CHANNEL_CAPITAL_FEASIBILITY_QUEUE.csv`
- Hidden run CSV: `outputs\XAUUSD_H4_CHANNEL_CAPITAL_FEASIBILITY_RUN.csv`
- Log files scanned: `2`
- Expected rows: `3`
- Parsed exported reports: `3`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `h4ct_capital_l40` | capital_feasibility_probe | capital_feasibility_diagnostic | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `h4ct_capital_l55` | capital_feasibility_probe | capital_feasibility_diagnostic | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| `h4ct_capital_l80` | capital_feasibility_probe | capital_feasibility_diagnostic | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
