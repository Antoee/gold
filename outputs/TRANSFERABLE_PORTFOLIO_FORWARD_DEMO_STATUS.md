...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 16:57:20 -05:00`
...
| Elapsed since registration | 2.54 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=180742.1s; identity=True |
