...
- Queue manifest: `outputs\RC2_REVERSION_FEATURE_TELEMETRY_MODEL1_QUEUE.csv`
- Hidden run CSV: `outputs\RC2_REVERSION_FEATURE_TELEMETRY_MODEL1_RUN.csv`
- Log files scanned: `2`
- Expected rows: `1`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `rc2_reversion_feature_telemetry` | behavior_preserving_telemetry_fork | feature_telemetry_model1 | 1 | 0 | 1 | 814.7 | 814.7 | 2.04 | 2.04 | 1.01 | 1.87 | 152 |
