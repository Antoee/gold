...
MODULE_PATH = ROOT / "work" / "evaluate_rdmc_second_broker_validation_gate.py"
...
import collect_rdmc_second_broker_validation_results as COLLECTOR  # noqa: E402
...
print("RDMC_SECOND_BROKER_GATE_TEST_PASS cases=16 rows=18 waves=3 model4_only=true")
