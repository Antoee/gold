...
#property description "Research fork with an optional D1 momentum-strength gate"
...
input bool   InpMOUseMinimumD1MomentumStrength = false;
input double InpMOMinimumAbsoluteD1MomentumPercent = 2.0;
...
private:
   ...
   {
      double ignoredMomentumPercent = 0.0;
   ...
   bool RegimeAllows(const bool buy, const double closePrice, const double atr)
   {
      ...
      double absoluteMomentumPercent = 0.0;
      int direction = MomentumDirection(absoluteMomentumPercent);
      if(InpMOUseMinimumD1MomentumStrength &&
         absoluteMomentumPercent < InpMOMinimumAbsoluteD1MomentumPercent)
         return false;
...
bool InputsValid()
{
   ...
   if(InpMOMomentumLookbackBars < 20 || InpMOEntryLookbackBars < 3 ||
      ...
      InpMOMinimumAbsoluteD1MomentumPercent < 0.0 ||
      InpMOMinimumAbsoluteD1MomentumPercent > 100.0 ||
