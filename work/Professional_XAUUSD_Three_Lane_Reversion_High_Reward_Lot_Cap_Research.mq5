...
#property description "Research fork with completed-bar strong-signal high-reward reversion lot-cap allocation"
...
input bool   InpRVUseHighRewardLotCap = false;
input double InpRVHighRewardMinimumRiskReward = 2.50;
input double InpRVHighRewardMaximumPositionLots = 0.20;
...
private:
   ...
   bool OpenPosition(const bool buy,
                     ...
                     const double adjustedRiskReward)
   {
      ...
      eventReason += "; adjusted RR " + DoubleToString(adjustedRiskReward, 3);
   ...
   void TryEntry()
   {
      ...
      if(InpRVUseHighRewardLotCap && InpRVUseStrongSignalLotCap &&
         signalBodyRatio >= InpRVStrongSignalMinimumBodyRatio &&
...
bool InputsValid()
{
   ...
   if(InpRVATRPeriod < 2 || InpRVADXPeriod < 2 || InpRVRSIPeriod < 2 ||
      ...
      (InpRVUseHighRewardLotCap &&
       (!InpRVUseStrongSignalLotCap ||
        InpRVHighRewardMinimumRiskReward <= InpRVMinimumRiskReward ||
        InpRVHighRewardMinimumRiskReward > 20.0 ||
        InpRVHighRewardMaximumPositionLots <= InpRVStrongSignalMaximumPositionLots ||
        InpRVHighRewardMaximumPositionLots > 1.0)) ||
