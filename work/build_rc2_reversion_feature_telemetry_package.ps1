param(
   [string]$SourcePath = "work\Professional_XAUUSD_RC2_Reversion_Feature_Telemetry.mq5",
   [string]$PackageDir = "outputs\rc2_reversion_feature_telemetry_model1_package",
   [string]$QueueManifestPath = "outputs\RC2_REVERSION_FEATURE_TELEMETRY_MODEL1_QUEUE.csv",
   [string]$PackageManifestPath = "outputs\RC2_REVERSION_FEATURE_TELEMETRY_MODEL1_PACKAGE_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\RC2_REVERSION_FEATURE_TELEMETRY_CONTRACT.md"
)
...
$expectedSourceHash = "13CF38517BF6859CCD620C3CF658CF278452B3387E5690D44391F4E95B141BC4"
...
Set-PinnedInput $inputs "InpRVLogFileName" "RC2_REVERSION_FEATURE_TELEMETRY_RV_2015_2018.csv" -StringValue
Set-PinnedInput $inputs "InpMOLogFileName" "RC2_REVERSION_FEATURE_TELEMETRY_MO_2015_2018.csv" -StringValue
Set-PinnedInput $inputs "InpEvidenceSourceHash" $sourceHash -StringValue
Set-PinnedInput $inputs "InpEvidenceRunLabel" "rc2_reversion_feature_telemetry_2015_2018" -StringValue
...
$profileName = "rc2_reversion_feature_telemetry_2015_2018.set"
$profilePath = Join-Path $profileDir $profileName
@($inputs.Keys | Sort-Object | ForEach-Object { $inputs[$_] }) |
   Set-Content -LiteralPath $profilePath -Encoding ASCII
$profileHash = (Get-FileHash -LiteralPath $profilePath -Algorithm SHA256).Hash

$configName = "001_rc2_reversion_feature_telemetry_2015_2018_m1.ini"
$reportName = "rc2_reversion_feature_telemetry_2015_2018_m1"
Write-SeasonalTesterConfig -Path (Join-Path $configDir $configName) -ReportRoot $reportDir `
   -ReportName $reportName -From "2015.01.01" -To "2018.12.31" `
   -Inputs $inputs -Model 1 -Deposit 10000

$stopRule = "Telemetry only. Feature selection may use 2015-2018 outcomes; 2019-2020 remains unopened until one threshold family and its neighbors are frozen."
$queue = [pscustomobject]@{
   QueueRank=1; Candidate="rc2_reversion_feature_telemetry"; CandidateRank=1
   SourceType="behavior_preserving_telemetry_fork"; SourceRank=1; Phase="feature_telemetry_model1"
   Set=$profileName; Window="feature_selection_2015_2018"; From="2015.01.01"; To="2018.12.31"
...
$manifest = [pscustomobject]@{
   QueueRank=1; Candidate="rc2_reversion_feature_telemetry"; Phase="feature_telemetry_model1"
   PhaseLabel="RC2 reversion feature telemetry Model1"
   Window="feature_selection_2015_2018"; Model=1; Deposit=10000
