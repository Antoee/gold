...
**2026-07-18 active repair queue: no new best yet. Exact annual ledgers show that momentum produced all 32 trades in 2019 and `-$71.78` of the `-$92.78` loss in 2022. A weekday explanation was rejected because Wednesday is the strongest weekday over all 342 annual trades. An isolated completed-H1 signal-range gate compiled with `0 errors, 0 warnings`; its frozen `1.00 / 1.25 / 1.50 ATR` family is queued for only eight Model1 early-gate runs on 2019 and 2022. The run plan is `LOCKED` and has generated zero reports, so no result or candidate change is being claimed.**
