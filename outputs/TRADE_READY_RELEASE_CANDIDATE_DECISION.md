...
- Source profile hash: `7AA4135B6FBA2FFC59B48E6EB68E0F7E954AB9BA18054BCA3E658AC0FEAD6BAF`
- Evidence profile id: `trade_ready_conservative`
- Evidence source hash: `A167CDB787E09F6E97B961D46963452527936434245FC42C7593E94EDF504622`
...
| --- | --- | --- | --- | --- | --- |
| profile-source | PASS | exists=True; hash=7AA4135B6FBA2FFC59B48E6EB68E0F7E954AB9BA18054BCA3E658AC0FEAD6BAF; evidenceProfile=trade_ready_conservative; evidenceSource=A167CDB787E09F6E97B961D46963452527936434245FC42C7593E94EDF504622; evidenceRun=trade_ready_conservative_validation | Conservative profile exists with evidence identity | outputs\CANDIDATE_TRADE_READY_CONSERVATIVE_PROFILE.set | Generate the conservative trade-ready profile. |
| live-readiness-decision | PENDING | rows=14; pass=7; pending=7; fail=0 | Final live-readiness decision has zero pending and zero failed gates | outputs\TRADE_READY_LIVE_READINESS_DECISION.csv | Close every live-readiness gate before release review. |
| money-ready-scorecard | PENDING | rows=20; pass=7; pending=13; fail=0 | Money-ready scorecard has zero pending and zero failed rows | outputs\MONEY_READY_STATUS_SCORECARD.csv | Regenerate the scorecard after proof gates pass. |
