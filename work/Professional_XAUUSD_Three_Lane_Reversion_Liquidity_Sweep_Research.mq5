...
#property description "Research fork with optional completed-bar reversion liquidity-sweep confirmation"
...
input bool   InpRVUseLiquiditySweepGate = false;
input int    InpRVLiquiditySweepLookbackBars = 5;
input double InpRVMinimumLiquiditySweepATR = 0.0;
...
private:
   ...
   bool LiquiditySweepAllows(const bool buy,
                             ...
                             const double atr)
   {
      if(!InpRVUseLiquiditySweepGate)
         return true;

      int lookback = MathMax(2, InpRVLiquiditySweepLookbackBars);
      double priorExtreme = 0.0;
      double minimumSweep = MathMax(_Point,
                                    atr * MathMax(0.0, InpRVMinimumLiquiditySweepATR));
      if(buy)
      {
