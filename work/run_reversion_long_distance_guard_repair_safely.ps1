...
param(
   ...
   [string]$OutputPrefix = "REVERSION_LONG_DISTANCE_GUARD_REPAIR_PORTABLE"
)
...
try {
   ...
   Set-Content -LiteralPath $unlock -Value "User-authorized isolated reversion long-distance repair." -Encoding ASCII
   ...
   Set-Content -LiteralPath $hardLock -Value "Restored after isolated reversion long-distance repair." -Encoding ASCII
}
