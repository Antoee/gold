...
- Latest probe decision: ISLP MinATR5 is not promoted as primary; monthly Model4 total was `+$3,615.61` vs `+$3,637.53`
...
| Latest code probe | ISLP MinATR5 removed the losing month but lowered monthly total profit; not promoted as primary |
...
1. Compare the `2024_06` ISLP winner against the `2024_10` ISLP loser.
2. Find a narrower structural/price-action guard that blocks `2024_10` without deleting `2024_06`.
3. Re-test any new guard through sampled, monthly, then quarterly Model4 gates.
...
- ISLP MinATR5 is a conservative risk-smoothing candidate only; it is not promoted as primary because monthly total profit was lower.
