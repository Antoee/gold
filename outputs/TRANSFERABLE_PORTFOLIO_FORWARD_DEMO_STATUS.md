...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 10:21:54 -05:00`
...
| Elapsed since registration | 2.27 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=157016.2s; identity=True |
