...
#property description "Research fork with completed-bar tiered strong-signal reversion lot-cap allocation"
...
input bool   InpRVUseVeryStrongSignalLotCap = false;
input double InpRVVeryStrongSignalMinimumBodyRatio = 0.40;
input double InpRVVeryStrongSignalMaximumPositionLots = 0.20;
...
private:
   ...
   void TryEntry()
   {
      ...
      if(InpRVUseVeryStrongSignalLotCap &&
