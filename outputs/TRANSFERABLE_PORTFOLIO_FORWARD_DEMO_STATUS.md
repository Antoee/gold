...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 03:10:56 -05:00`
...
| Elapsed since registration | 2.97 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=217558.6s; identity=True |
