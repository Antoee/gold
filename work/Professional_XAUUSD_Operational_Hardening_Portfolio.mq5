...
#property description "Operationally hardened XAUUSD reversion and multiscale-momentum portfolio EA"

#include <Trade/Trade.mqh>

input group "Portfolio Identity and Safety"
input string InpAllowedSymbol = "XAUUSD";
input ulong  InpPortfolioMagic = 26071780;
...
{
   return "XAU_TLP2_CAP_" + IntegerToString((long)AccountInfoInteger(ACCOUNT_LOGIN)) +
          "_" + IntegerToString((long)InpPortfolioMagic);
}
