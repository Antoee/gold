param(
   ...
   [string]$PackageDir = "outputs\operational_hardening_portfolio_model1_package",
   [string]$QueueManifestPath = "outputs\OPERATIONAL_HARDENING_PORTFOLIO_MODEL1_QUEUE.csv",
   [string]$PackageManifestPath = "outputs\OPERATIONAL_HARDENING_PORTFOLIO_MODEL1_PACKAGE_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\OPERATIONAL_HARDENING_PORTFOLIO_MODEL1_PACKAGE.md"
)
...
Set-PinnedInput -Inputs $inputs -Name "InpRVLogFileName" -Value "OPERATIONAL_HARDENING_RV_MODEL1_EVENTS.csv" -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpMOLogFileName" -Value "OPERATIONAL_HARDENING_MO_MODEL1_EVENTS.csv" -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpEvidenceSourceHash" -Value $sourceHash -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpEvidenceRunLabel" -Value "operational_hardening_model1" -StringValue
...
$profileName = "operational_hardening_rv045_mo015_model1.set"
$profilePath = Join-Path $profileDir $profileName
@($inputs.Keys | Sort-Object | ForEach-Object { $inputs[$_] }) |
   Set-Content -LiteralPath $profilePath -Encoding ASCII
$profileHash = (Get-FileHash -LiteralPath $profilePath -Algorithm SHA256).Hash

$configName = "001_operational_hardening_continuous_2015_2026_m1.ini"
$reportName = "operational_hardening_continuous_2015_2026_m1"
...
$queue = [pscustomobject]@{
   ...
   SourceType="transferable_portfolio_safety_fork"; SourceRank=1; Phase="continuous_model1_fidelity"
...
$manifest = [pscustomobject]@{
   QueueRank=1; Candidate="operational_hardening_rv045_mo015"; Phase="continuous_model1_fidelity"
   PhaseLabel="Operational-hardening Model1 schedule fidelity"
