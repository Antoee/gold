...
#property description "Research fork with an optional D1 momentum exhaustion guard"
...
input bool   InpMOUseMaximumD1MomentumStrength = false;
input double InpMOMaximumAbsoluteD1MomentumPercent = 18.0;
...
private:
   ...
   bool RegimeAllows(const bool buy, const double closePrice, const double atr)
   {
      ...
      if(InpMOUseMaximumD1MomentumStrength &&
...
bool InputsValid()
{
   ...
   if(InpMOMomentumLookbackBars < 20 || InpMOEntryLookbackBars < 3 ||
      ...
      InpMOMaximumAbsoluteD1MomentumPercent <= 0.0 ||
      InpMOMaximumAbsoluteD1MomentumPercent > 100.0 ||
