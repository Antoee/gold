...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 06:55:13 -05:00`
...
| Elapsed since registration | 3.12 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=231015.8s; identity=True |
