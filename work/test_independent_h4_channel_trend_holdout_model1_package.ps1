...
$expectedCandidates = @('h4ct_trail_40_20_l20_a25','h4ct_trail_55_20_l20_a25','h4ct_trail_55_20_l20_a30','h4ct_trail_80_40_l20_a30')
...
foreach($candidate in ($queue | Group-Object Candidate)) {
   ...
   foreach($required in @('InpRiskPercent=0.10','InpUseChandelierTrail=true','InpUseAccountWideExposureGuard=true','InpUseRealAccountSafetyLock=true','InpAllowRealAccountTrading=false')) {
