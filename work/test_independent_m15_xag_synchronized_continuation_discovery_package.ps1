...
foreach($row in $manifest) {
   ...
   foreach($token in @('Expert=Professional_XAUUSD_EA.ex5','Model=1','Visual=0','InpReferenceSymbol=XAGUSD','InpRiskPercent=0.10','InpAllowRealAccountTrading=false','InpRequireFreshBreakout=true')) {
