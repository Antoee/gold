...
$primaryIdentity = $primaryDecision.SourceSha256 -eq $registration.sourceSha256 -and $primaryDecision.ProfileSha256 -eq $registration.researchProfileSha256
...
$ledgerIdentity = $ledgerDecision.SourceSha256 -eq $registration.sourceSha256 -and $ledgerDecision.ProfileSha256 -eq $registration.researchProfileSha256
...
$brokerIdentity = $secondBrokerDecision.SourceSha256 -eq $registration.sourceSha256 -and $secondBrokerDecision.ProfileSha256 -eq $registration.researchProfileSha256
