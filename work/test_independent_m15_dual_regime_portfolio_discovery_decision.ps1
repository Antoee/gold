...
[pscustomobject]@{ Status="PASS"; Decision=$decision.Status; Reports=45; Candidates=15; IdentityPasses=45; DiscoveryEligible=$eligible.Count; HoldoutOpened=$false; Model4Opened=$false; ResultsSha256=$hash }
