...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 23:41:09 -05:00`
...
| Elapsed since registration | 2.82 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=204971.2s; identity=True |
