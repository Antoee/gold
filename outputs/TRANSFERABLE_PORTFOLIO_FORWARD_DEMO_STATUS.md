...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 13:46:09 -05:00`
...
| Elapsed since registration | 1.41 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=82871.2s; identity=True |
