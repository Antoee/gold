...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 15:31:35 -05:00`
...
| Elapsed since registration | 2.48 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=175597.5s; identity=True |
