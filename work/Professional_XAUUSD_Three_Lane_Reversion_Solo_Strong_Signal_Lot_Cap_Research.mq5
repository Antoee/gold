...
#property description "Research fork with portfolio-solo strong reversion lot-cap allocation"
...
input bool   InpRVUseSoloStrongSignalLotCap = false;
input double InpRVSoloStrongSignalMaximumPositionLots = 0.18;
...
private:
   ...
   void TryEntry()
   {
      ...
      if(InpRVUseSoloStrongSignalLotCap &&
         signalBodyRatio >= InpRVStrongSignalMinimumBodyRatio &&
