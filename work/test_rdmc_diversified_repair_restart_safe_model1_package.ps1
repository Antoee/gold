...
Add-Check "peak persistence failure closes entry path" ($source.Contains('g_peakEquityPersistenceHealthy = false;') -and $source.Contains('!g_peakEquityPersistenceHealthy || !g_criticalPersistenceHealthy') -and $source.Contains('Failed to initialize critical persistent risk state.')) "fail closed"
