...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 22:05:10 -05:00`
...
| Elapsed since registration | 2.76 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=199212.2s; identity=True |
