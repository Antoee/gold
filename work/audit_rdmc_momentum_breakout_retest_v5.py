...
WINDOWS = ("2015_2018",)
OUT_CSV = REPO / "outputs" / "RDMC_MOMENTUM_BREAKOUT_RETEST_V5_LANE_RISK_AUDIT.csv"
OUT_MD = REPO / "outputs" / "RDMC_MOMENTUM_BREAKOUT_RETEST_V5_LANE_RISK_AUDIT.md"
...
for window in WINDOWS:
    ledger_path = REPO / "outputs" / f"RDMC_MOMENTUM_BREAKOUT_RETEST_V5_{window}_TRADES.csv"
...
print(
    "RDMC_MOMENTUM_BREAKOUT_RETEST_V5_AUDIT_PASS "
