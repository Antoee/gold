...
| Handoff integrity | PASS | Full handoff, stress micro handoff, and recent-OOS handoff are statically prepared for controlled tester use. | Use handoff packs only during a controlled non-interrupting tester window. |
