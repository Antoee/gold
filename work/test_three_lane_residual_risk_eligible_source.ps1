...
$forkPath = Join-Path $repo 'work\Professional_XAUUSD_Three_Lane_Residual_Risk_Eligible_Research.mq5'
$expectedBaseHash = '2F1C1C74067DA6173EB4133DB75C0B0DB4DE7BE46F2BB7A453AEE044536B2158'
$expectedForkHash = 'D468B984972E84FE2F0E368035EB74841D8B1856AEA56A893FB819DFE4C482E4'
...
$baseEligibilityCount = ([regex]::Matches($fork, [regex]::Escape('if(baseLots <= 0.0)'))).Count
if($baseEligibilityCount -ne 3) { throw "Expected three base-lot eligibility gates, found $baseEligibilityCount" }
...
[pscustomobject][ordered]@{
   ...
   NewTradePaths = 0
   BaseEligibilityGates = $baseEligibilityCount
