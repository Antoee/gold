...
#property description "Research fork with tightening-only protection for strong reversion signals"
...
private:
   ...
   void ManageStrongPositionOnBar()
   {
                     ...
                     const bool strongSignal)
   {
      ...
      if(!PostFillReconcile(m_trade, InpRVMagicNumber, buy, requestedRiskPercent,
         ...
         return false;
      if(InpRVUseStrongSignalProtection && strongSignal && !RegisterStrongRisk(ticket))
      {
         string rejectReason = "";
