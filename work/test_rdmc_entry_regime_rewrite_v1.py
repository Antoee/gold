...
SOURCE = ROOT / "outputs" / "rdmc_entry_regime_rewrite_v1_package" / "source" / "Professional_XAUUSD_EA.mq5"
PROFILE = ROOT / "outputs" / "rdmc_entry_regime_rewrite_v1_package" / "profiles" / "rdmc_entry_regime_rewrite_v1.set"
...
require(profile["InpEvidenceProfileId"] == "rdmc_entry_regime_rewrite_v1", "profile id changed")
...
for token in (
    ...
    "FastMomentumAllows",
    "EntryQualityAllows",
    "InpMOMinimumTickVolumeRatio",
    "InpMOMinimumBreakoutCloseLocationPercent",
):
...
print("RDMC_ENTRY_REGIME_REWRITE_V1_TEST_PASS inputs=600 identity=exact predecessor=unchanged")
