...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 07:58:51 -05:00`
...
| Elapsed since registration | 1.17 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=62033.8s; identity=True |
