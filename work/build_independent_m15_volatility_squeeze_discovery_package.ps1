param(
   ...
   [string]$PackageDir = "outputs\independent_m15_volatility_squeeze_discovery_model1_package",
   [string]$QueueManifestPath = "outputs\INDEPENDENT_M15_VOLATILITY_SQUEEZE_DISCOVERY_MODEL1_QUEUE.csv",
   [string]$PackageManifestPath = "outputs\INDEPENDENT_M15_VOLATILITY_SQUEEZE_DISCOVERY_MODEL1_PACKAGE_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\INDEPENDENT_M15_VOLATILITY_SQUEEZE_DISCOVERY_MODEL1_PACKAGE.md"
)
...
$variants = @(
   [pscustomobject]@{ Name="m15sq_center"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_sq2"; Squeeze="2"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_sq4"; Squeeze="4"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_kc140"; Squeeze="3"; KC="1.40"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_kc160"; Squeeze="3"; KC="1.60"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_break8"; Squeeze="3"; KC="1.50"; Breakout="8"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_break16"; Squeeze="3"; KC="1.50"; Breakout="16"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_channel275"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="2.75"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_exp090"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="0.90"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_exp130"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.30"; TPR="1.50"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_tp125"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.25"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_tp200"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="2.00"; Trend="true"; TrendEMA="100" },
   [pscustomobject]@{ Name="m15sq_trend50"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="50" },
   [pscustomobject]@{ Name="m15sq_trend200"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="true"; TrendEMA="200" },
   [pscustomobject]@{ Name="m15sq_notrend"; Squeeze="3"; KC="1.50"; Breakout="12"; Channel="3.50"; Expansion="1.10"; TPR="1.50"; Trend="false"; TrendEMA="100" }
)
$windows = @(
...
foreach($variant in $variants) {
   ...
   foreach($pair in @(
      ...
      @("InpEvidenceSourceHash",$sourceHash), @("InpEvidenceRunLabel","independent_m15_volatility_squeeze_discovery_model1"),
   ...
   foreach($window in $windows) {
      ...
      $queueRows.Add([pscustomobject]@{
         QueueRank=$rank; Candidate=$variant.Name; CandidateRank=$candidateRank; SourceType="independent_m15_volatility_squeeze"
         ...
         TakeProfitR=$variant.TPR; UseTrend=$variant.Trend; TrendEMAPeriod=$variant.TrendEMA; StopRule=$stopRule
      }) | Out-Null
      $runRows.Add([pscustomobject]@{
         QueueRank=$rank; Candidate=$variant.Name; Phase="discovery_model1"
         PhaseLabel="Independent M15 volatility-squeeze discovery Model1"; Window=$window.Name; Model=1; Deposit=10000
