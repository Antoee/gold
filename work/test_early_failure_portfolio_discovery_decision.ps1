param(
   ...
   [string]$DecisionPath = "outputs\EARLY_FAILURE_PORTFOLIO_DISCOVERY_DECISION.csv",
...
if(@($summary | Where-Object { $_.Candidate -eq 'efp_fixed_control' -and $_.Decision -ne 'CONTROL_ONLY' }).Count -ne 0) { throw "Unchanged control became promotable." }
