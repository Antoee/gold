...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 08:53:36 -05:00`
...
| Elapsed since registration | 1.21 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=65318.8s; identity=True |
