...
input string InpProbeId = "xau_xag_history_feasibility";
input string InpSourceSha256 = "";
input string InpOutputFileName = "XAUUSD_XAGUSD_History_Feasibility.csv";
...
void WriteEvidence()
{
   ...
   {
      Print("XAU_XAG_HISTORY_FILE_ERROR code=", GetLastError());
      return;
   }
...
int OnInit()
{
   ...
   {
      Print("XAU_XAG_HISTORY_SYMBOL_SELECT_ERROR symbol=", InpReferenceSymbol, " code=", GetLastError());
      return INIT_FAILED;
   }
