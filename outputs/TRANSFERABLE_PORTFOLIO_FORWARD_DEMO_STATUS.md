...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 09:38:58 -05:00`
...
| Elapsed since registration | 3.24 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=240840.9s; identity=True |
