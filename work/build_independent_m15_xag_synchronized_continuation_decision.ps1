param(
   ...
   [string]$CompileLogPath = "outputs\INDEPENDENT_M15_XAG_SYNCHRONIZED_CONTINUATION_COMPILE.log",
...
$md.Add('# Independent M15 XAG Synchronized-Continuation Decision')
$md.Add('')
$md.Add('## Decision')
$md.Add('')
$md.Add('**Rejected. No new best, no continuous test, no recent-data test, and no Model4 promotion.**')
$md.Add('')
$md.Add('The broker-data hypothesis was feasible, but the trading hypothesis was not: every one of the 16 nearby shapes lost money in both disjoint three-year eras. Drawdown remained below the 5% research ceiling because risk was small, but no profile reached PF 1.10 in both eras.')
$md.Add('')
