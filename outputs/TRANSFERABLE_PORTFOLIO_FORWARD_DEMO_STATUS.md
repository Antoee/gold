...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 21:07:20 -05:00`
...
| Elapsed since registration | 2.72 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=195742.8s; identity=True |
