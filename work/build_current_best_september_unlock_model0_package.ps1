param(
   [string]$PackageDir = "work\local_mt5_current_best_september_unlock_model0_package",
...
$windows = @(
   ...
   [pscustomobject]@{ Window = "2024_09"; Phase = "target"; Set = "target"; From = "2024.09.01"; To = "2024.09.30" },
   [pscustomobject]@{ Window = "2025_09"; Phase = "target"; Set = "target"; From = "2025.09.01"; To = "2025.09.30" },
   [pscustomobject]@{ Window = "2025_Q4"; Phase = "guard"; Set = "guard"; From = "2025.10.01"; To = "2025.12.31" },
   [pscustomobject]@{ Window = "2025_11"; Phase = "guard"; Set = "guard"; From = "2025.11.01"; To = "2025.11.30" },
   [pscustomobject]@{ Window = "2025_12"; Phase = "guard"; Set = "guard"; From = "2025.12.01"; To = "2025.12.31" },
   [pscustomobject]@{ Window = "2026_01"; Phase = "guard"; Set = "guard"; From = "2026.01.01"; To = "2026.01.31" },
...
$profiles = @(
   ...
   [pscustomobject]@{ Name = "sep012"; Overrides = @{ InpTradeSeptember = "true"; InpSeptemberRiskMultiplier = "0.12"; InpFlatMonthOpportunityBypassMinQualityScore = "12"; InpFlatMonthOpportunityBypassMinPriceActionScore = "8"; InpFlatMonthMaxEntryCount = "3"; InpFlatMonthMaxProfitPercent = "0.40"; InpUseAdaptiveReverse = "false" } },
   [pscustomobject]@{ Name = "sep015"; Overrides = @{ InpTradeSeptember = "true"; InpSeptemberRiskMultiplier = "0.15"; InpFlatMonthOpportunityBypassMinQualityScore = "11"; InpFlatMonthOpportunityBypassMinPriceActionScore = "7"; InpFlatMonthMaxEntryCount = "3"; InpFlatMonthMaxProfitPercent = "0.45"; InpUseAdaptiveReverse = "false" } },
   [pscustomobject]@{ Name = "sep020"; Overrides = @{ InpTradeSeptember = "true"; InpSeptemberRiskMultiplier = "0.20"; InpFlatMonthOpportunityBypassMinQualityScore = "11"; InpFlatMonthOpportunityBypassMinPriceActionScore = "7"; InpFlatMonthMaxEntryCount = "4"; InpFlatMonthMaxProfitPercent = "0.55"; InpUseAdaptiveReverse = "false" } }
)
...
foreach($profile in $profiles) {
   foreach($window in $windows) {
      ...
      $reportName = "current_best_september_unlock_model0_{0}_{1}" -f $profile.Name, $window.Window
...
$expected | Export-Csv -LiteralPath "outputs\CURRENT_BEST_SEPTEMBER_UNLOCK_MODEL0_MANIFEST.csv" -NoTypeInformation
"Built $rank current-best September unlock Model 0 configs in $PackageDir"
