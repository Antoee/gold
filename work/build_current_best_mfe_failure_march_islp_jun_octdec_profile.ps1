param(
   [string]$BaseProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_OCTDEC_PROFILE.set",
   [string]$OutProfilePath = "outputs\CANDIDATE_PRIMARY_RANGE_ELITE_MFE_FAILURE_MARCH_ISLP_JUN_OCTDEC_PROFILE.set"
)
...
$overrides = [ordered]@{
   ...
   InpISLPTradeJune = 'true||true||0||0||N'
