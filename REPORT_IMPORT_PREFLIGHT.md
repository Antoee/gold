...
| Optimization guardrails | TRACKED | Top score: giveback25_tp38=87. REVIEW_REQUIRED=16 | Use guardrail status to prioritize tester time and block promotion shortcuts. |
| Handoff integrity | PASS | 24 rows checked, 0 failures. | Handoff configs remain statically safe for a controlled tester window. |
| Local safety | PASS | 24 safety checks pass. | Keep local MT5 launch locked while the PC is in normal use. |
