...
- **Status:** `FAIL`
- **Updated:** `2026-07-17 05:04:38 -05:00`
...
| Sentinel heartbeat freshness and identity | PASS | present=True; valid=True; fresh=True; age=40.5s; identity=True |
...
| Minimum observation sample | PENDING | days=0.05/90; trades=0/30 |
