...
int             InpMaxSimultaneousPositions  = 1;
int             InpMaxTradesPerDay           = 4;
int             InpMinMinutesBetweenTrades   = 30;
...
bool            InpAllowFlatMonthLiquidityReclaimOutsideMonthFilter = false;
...
bool            InpUseFlatMonthCatchUpRiskRamp = false;
...
bool            InpUseFlatMonthLateCatchUp = false;
...
bool            InpUseFlatMonthMissedMoveTPExpansion = false;
...
bool            InpUseFlatMonthLiquidityReclaimLane = false;
...
bool            InpUseWinnerScaleIn          = false;
...
bool            InpUseHouseMoneyScaleInRiskRamp = false;
...
double          InpTradeReadyMaxRiskPercent = 0.75;
double          InpTradeReadyMaxOpenRiskPercent = 1.00;
double          InpTradeReadyMaxPositionLots = 0.10;
int             InpTradeReadyMaxSimultaneousPositions = 1;
double          InpTradeReadyMaxDailyLossPercent = 1.00;
double          InpTradeReadyMaxWeeklyLossPercent = 2.50;
double          InpTradeReadyMaxMonthlyLossPercent = 5.00;
double          InpTradeReadyMaxEquityDrawdownPercent = 10.00;
double          InpTradeReadyMaxSpreadPoints = 250.0;
double          InpTradeReadyMaxSpreadATRPercent = 12.0;
double          InpTradeReadyMaxDeviationPoints = 30.0;
input bool            InpUseTradeEnvironmentGuard = false;
int             InpTradeEnvMinSignalBars = 300;
int             InpTradeEnvMaxQuoteAgeSeconds = 30;
double          InpTradeEnvMaxStopsLevelPoints = 250.0;
double          InpTradeEnvMaxFreezeLevelPoints = 250.0;
bool            InpTradeEnvRequireTickValue = true;
...
bool            InpUseProfitOnlyRiskBoost    = false;
...
bool            InpUseClosedProfitOpportunityRiskBoost = false;
...
bool            InpUseHouseMoneyAccelerationGate = false;
...
bool            InpUseLossStreakRiskReduction = true;
int             InpLossStreakRiskReductionStart = 1;
double          InpLossStreakRiskReductionFactor = 0.50;
double          InpMinReducedRiskPercent     = 0.25;
bool            InpUseDrawdownRiskReduction  = true;
double          InpDrawdownRiskReductionStartPercent = 2.0;
double          InpDrawdownRiskReductionFullPercent = 8.0;
double          InpDrawdownRiskReductionMaxFactor = 0.50;
...
bool            InpUseHotStreakRiskBoost    = false;
...
bool            InpUseRecentProfitFactorRiskBoost = false;
...
bool            InpUseDrawdownQualityGate    = false;
double          InpDrawdownQualityStartPercent = 2.0;
double          InpDrawdownQualityFullPercent = 8.0;
int             InpDrawdownQualityMinScore   = 7;
int             InpDrawdownQualityMaxScore   = 12;
...
bool            InpUseProtectedCushionRiskBoost = false;
...
double          InpMaxDailyLossPercent       = 1.00;
...
double          InpDailyProfitLockPercent    = 1.50;
...
bool            InpUseDailyEquityTrailGuard  = false;
double          InpDailyEquityTrailGivebackPercent = 40.0;
double          InpDailyEquityTrailMinProfitPercent = 0.50;
bool            InpUseWeeklyProfitLock       = false;
double          InpWeeklyProfitLockPercent   = 3.00;
...
bool            InpUseMonthlyProfitLock      = false;
double          InpMonthlyProfitLockPercent  = 6.00;
...
double          InpMaxWeeklyLossPercent      = 2.50;
...
double          InpMaxMonthlyLossPercent     = 4.00;
...
bool            InpClosePositionsOnRiskLimit = false;
bool            InpUseProfitGivebackGuard    = false;
double          InpDailyProfitGivebackPercent = 35.0;
double          InpWeeklyProfitGivebackPercent = 35.0;
double          InpMonthlyProfitGivebackPercent = 35.0;
...
int             InpMaxDailyLossCount         = 2;
int             InpMaxWeeklyLossCount        = 5;
int             InpMaxMonthlyLossCount       = 10;
int             InpMaxConsecutiveLosses      = 4;
int             InpCooldownMinutesAfterLoss  = 60;
double          InpMaxSpreadPoints           = 350;
double          InpMaxSpreadATRPercent       = 18.0;
...
int             InpSpreadRegimeLookbackBars  = 24;
input double          InpMaxSpreadRegimeRatio      = 2.00;
double          InpMinSpreadRegimePoints     = 50.0;
input bool            InpUseM1SpreadShockGuard     = false;
int             InpM1SpreadShockLookbackBars = 30;
input double          InpM1SpreadShockMaxRatio     = 2.50;
double          InpM1SpreadShockMinPoints    = 60.0;
bool            InpUseSpreadRiskScaling      = false;
double          InpSpreadRiskStartPoints     = 120.0;
double          InpMinSpreadRiskMultiplier   = 0.60;
int             InpDeviationPoints           = 40;
double          InpMinRiskReward             = 1.50;
input bool            InpUseSpreadAdjustedRRFilter = false;
double          InpMinSpreadAdjustedRR       = 1.20;
bool            InpUseTradingCostGuard       = false;
double          InpEstimatedRoundTurnCommissionPerLot = 0.00;
double          InpMaxTradingCostRiskPercent = 12.0;
input double          InpMaxPositionLots           = 10.0;
bool            InpAllowMinLotRiskOverflow   = false;
double          InpMaxOpenRiskPercent        = 0.00;
bool            InpUseHouseMoneyOpenRiskExpansion = false;
...
bool            InpBlockUnprotectedExposure  = true;
bool            InpUseMarginGuard            = false;
double          InpMinMarginLevelPercent     = 300.0;
double          InpMaxTradeMarginFreePercent = 20.0;
bool            InpUseMarginAwareLotCap      = false;
bool            InpUseMarginPressureRiskScaling = false;
double          InpMarginPressureStartLevelPercent = 600.0;
double          InpMinMarginPressureRiskMultiplier = 0.50;
bool            InpUseTradeMarginRiskScaling = false;
double          InpTradeMarginRiskStartFraction = 0.50;
double          InpMinTradeMarginRiskMultiplier = 0.50;
...
bool            InpUseQualityTakeProfitScaling = false;
...
bool            InpUseRunnerTakeProfitExpansion = false;
...
bool            InpUseFlatMonthCatchUpTakeProfitExpansion = false;
...
bool            InpUseProtectedCushionTakeProfitExpansion = false;
...
bool            InpUseClosedProfitTakeProfitExpansion = false;
...
bool            InpUseEliteConfluenceTakeProfitExpansion = false;
...
bool            InpUseProtectedCushionUnlimitedRunner = false;
...
bool            InpUseEliteContinuationUnlimitedRunner = false;
...
bool            InpUseStructureStop          = true;
int             InpStructureLookbackBars     = 12;
bool            InpUseConfirmedSwingPivotStop = false;
...
bool            InpLiquidityStopUsePreviousDay = false;
bool            InpLiquidityStopUsePreviousWeek = false;
bool            InpLiquidityStopUsePreviousMonth = false;
input bool            InpLiquidityStopAllowWiderMaxATR = true;
input double          InpLiquidityStopMaxATRMultiplier = 5.00;
bool            InpUseLiquidityClusterStopExtension = false;
...
bool            InpUseLiquidityPocketStopShift = false;
...
bool            InpUseHighEfficiencyTrendLane = false;
int             InpHighEfficiencyTrendMode = 0;
int             InpHighEfficiencyTrendMinScore = 6;
double          InpHighEfficiencyTrendRiskMultiplier = 0.65;
int             InpHighEfficiencyTrendMaxMonthlyEntries = 6;
int             InpHighEfficiencyTrendSpacingMinutes = 180;
double          InpHighEfficiencyTrendStopATRMultiplier = 1.25;
double          InpHighEfficiencyTrendTakeProfitATRMultiplier = 2.40;
double          InpHighEfficiencyTrendMinRR = 1.25;
...
bool            InpUseTickSpeedImpulse       = false;
...
double          InpBreakEvenBufferPoints     = 30;
bool            InpUseATRTrailing            = true;
double          InpTrailATRMultiplier        = 1.60;
bool            InpUseHouseMoneyATRTrailStretch = false;
...
bool            InpUsePostPartialRunnerTPExpansion = false;
...
bool            InpUseProtectedRunnerPartialClose = false;
...
bool            InpUseProfitLockStop         = false;
double          InpProfitLockTriggerATR      = 1.50;
double          InpProfitLockATR             = 0.35;
bool            InpUseRProfitLockStop        = false;
...
bool            InpUseHouseMoneyMFEProfitLockStretch = false;
...
bool            InpUseHouseMoneyMFEGivebackStretch = false;
...
bool            InpUsePowerTrendRunnerPatience = false;
...
bool            InpUseLondonSession          = true;
int             InpLondonStartHour           = 7;
int             InpLondonEndHour             = 11;
bool            InpUseNewYorkSession         = true;
int             InpNewYorkStartHour          = 13;
input int             InpNewYorkEndHour            = 17;
bool            InpUseCustomSession          = false;
int             InpCustomStartHour           = 0;
int             InpCustomEndHour             = 23;
