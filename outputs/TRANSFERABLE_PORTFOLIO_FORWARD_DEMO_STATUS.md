...
- **Status:** `FAIL`
- **Updated:** `2026-07-18 21:22:01 -05:00`
...
| Elapsed since registration | 1.73 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=110223.6s; identity=True |
