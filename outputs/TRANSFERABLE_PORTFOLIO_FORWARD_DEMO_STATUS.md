...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 02:24:43 -05:00`
...
| Elapsed since registration | 1.94 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=128385.3s; identity=True |
