...
- **Status:** `FAIL`
- **Updated:** `2026-07-20 01:20:17 -05:00`
...
| Elapsed since registration | 2.89 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=210919.9s; identity=True |
