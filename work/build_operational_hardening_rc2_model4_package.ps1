param(
   ...
   [string]$PackageDir = "outputs\operational_hardening_rc2_model4_package",
   [string]$QueueManifestPath = "outputs\OPERATIONAL_HARDENING_RC2_MODEL4_QUEUE.csv",
   [string]$PackageManifestPath = "outputs\OPERATIONAL_HARDENING_RC2_MODEL4_PACKAGE_MANIFEST.csv",
   [string]$MarkdownPath = "outputs\OPERATIONAL_HARDENING_RC2_MODEL4_PACKAGE.md"
)
...
Set-PinnedInput -Inputs $inputs -Name "InpRVLogFileName" -Value "OPERATIONAL_HARDENING_RC2_RV_MODEL4_EVENTS.csv" -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpMOLogFileName" -Value "OPERATIONAL_HARDENING_RC2_MO_MODEL4_EVENTS.csv" -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpEvidenceSourceHash" -Value $sourceHash -StringValue
Set-PinnedInput -Inputs $inputs -Name "InpEvidenceRunLabel" -Value "operational_hardening_rc2_model4" -StringValue
...
$profileName = "operational_hardening_rc2_rv045_mo015_model4.set"
$profilePath = Join-Path $profileDir $profileName
@($inputs.Keys | Sort-Object | ForEach-Object { $inputs[$_] }) |
   Set-Content -LiteralPath $profilePath -Encoding ASCII
$profileHash = (Get-FileHash -LiteralPath $profilePath -Algorithm SHA256).Hash

$configName = "001_operational_hardening_rc2_continuous_2015_2026_m4.ini"
$reportName = "operational_hardening_rc2_continuous_2015_2026_m4"
...
$queue = [pscustomobject]@{
   ...
   SourceType="dedicated_account_safety_fork"; SourceRank=1; Phase="continuous_model4_fidelity"
...
$manifest = [pscustomobject]@{
   QueueRank=1; Candidate="operational_hardening_rc2_rv045_mo015"; Phase="continuous_model4_fidelity"
   PhaseLabel="Operational-hardening rc2 Model4 real-tick schedule fidelity"
