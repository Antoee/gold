...
- **Status:** `FAIL`
- **Updated:** `2026-07-19 00:39:23 -05:00`
...
| Elapsed since registration | 1.86 | information only; invalid while account contract fails |
| Closed trades | 0 | 30 |
...
| Sentinel heartbeat freshness and identity | ATTENTION | present=True; valid=True; fresh=False; age=122065.0s; identity=True |
