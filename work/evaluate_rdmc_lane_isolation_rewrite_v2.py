...
MANIFEST = ROOT / "outputs" / "RDMC_LANE_ISOLATION_REWRITE_V2_WAVE_01_MANIFEST.csv"
RESULTS = ROOT / "outputs" / "RDMC_LANE_ISOLATION_REWRITE_V2_WAVE_01_RESULTS.csv"
EVALUATION = ROOT / "outputs" / "RDMC_LANE_ISOLATION_REWRITE_V2_WAVE_01_EVALUATION.csv"
DECISION = ROOT / "outputs" / "RDMC_LANE_ISOLATION_REWRITE_V2_DECISION_FIXTURE.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_LANE_ISOLATION_REWRITE_V2_DECISION.md"
EXPECTED_MANIFEST = "24F5B32D6F12740E763DC3BA4B14F0BBA5E892381D46EE33190C4C0F320756F7"
...
def main() -> int:
    ...
    lines = [
        "# RDMC Lane Isolation Rewrite v2 Decision",
        "",
