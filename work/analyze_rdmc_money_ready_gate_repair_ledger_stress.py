...
GATE_DECISION = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_DECISION.csv"
REPORT_ROOT = ROOT / "outputs" / "rdmc_money_ready_gate_repair_executable_package" / "reports_here"
TRADES_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_TRADES.csv"
COST_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_COST_STRESS.csv"
MC_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_ORDER_AWARE_MONTE_CARLO.csv"
DECISION_CSV = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_STRESS_DECISION.csv"
DECISION_MD = ROOT / "outputs" / "RDMC_MONEY_READY_GATE_REPAIR_EXECUTABLE_LEDGER_STRESS_DECISION.md"
...
def write_waiting(gate_status: str, launch_locked: bool) -> None:
    ...
    lines = [
        "# RDMC Money-Ready Gate Repair Executable Ledger Stress Decision",
        "",
